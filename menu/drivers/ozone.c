...
#define OZONE_ENTRY_ONSCREEN(ozone, idx) \
	(((idx) >= (ozone)->first_onscreen_entry) && ((idx) <= (ozone)->last_onscreen_entry))
...
enum OZONE_TEXTURE { OZONE_TEXTURE_RETROARCH = 0, OZONE_TEXTURE_CURSOR_BORDER, OZONE_TEXTURE_LAST };
...
struct ozone_handle {
	...
	size_t (*word_wrap)(char *s, size_t len, const char *src, size_t src_len, int line_width, int wideglyph_width,
						unsigned max_lines);
...
static float ozone_sidebar_gradient_top_light[16] = {
	0.94f,	0.94f,	0.94f,	1.00f, 0.94f,  0.94f,  0.94f,  1.00f,
	0.922f, 0.922f, 0.922f, 1.00f, 0.922f, 0.922f, 0.922f, 1.00f,
};
...
static float ozone_sidebar_gradient_top_dark[16] = {
	0.2f, 0.2f, 0.2f, 1.00f, 0.2f, 0.2f, 0.2f, 1.00f, 0.18f, 0.18f, 0.18f, 1.00f, 0.18f, 0.18f, 0.18f, 1.00f,
};

static float ozone_sidebar_gradient_bottom_dark[16] = {
	0.18f, 0.18f, 0.18f, 1.00f, 0.18f, 0.18f, 0.18f, 1.00f, 0.2f, 0.2f, 0.2f, 1.00f, 0.2f, 0.2f, 0.2f, 1.00f,
};

static float ozone_sidebar_gradient_top_nord[16] = {
	0.2078431f, 0.2352941f, 0.2901961f, 1.0f, 0.2078431f, 0.2352941f, 0.2901961f, 1.0f,
	0.1921569f, 0.2196078f, 0.2705882f, 0.9f, 0.1921569f, 0.2196078f, 0.2705882f, 0.9f,
};
...
static float ozone_sidebar_gradient_top_gruvbox_dark[16] = {
	0.1960784f, 0.1882353f, 0.1843137f, 1.0f, 0.1960784f, 0.1882353f, 0.1843137f, 1.0f,
	0.1686275f, 0.1686275f, 0.1686275f, 0.9f, 0.1686275f, 0.1686275f, 0.1686275f, 0.9f,
};
...
static float ozone_sidebar_gradient_top_boysenberry[16] = {
	0.27058823529f, 0.09803921568f, 0.14117647058f, 1.00f, 0.27058823529f, 0.09803921568f, 0.14117647058f, 1.00f,
	0.19215686274f, 0.0f,			0.04705882352f, 1.00f, 0.19215686274f, 0.0f,		   0.04705882352f, 1.00f,
};
...
static float ozone_sidebar_gradient_top_hacking_the_kernel[16] = {
	0.0f, 0.13333333f, 0.0f, 1.0f, 0.0f, 0.13333333f, 0.0f, 1.0f,
	0.0f, 0.13333333f, 0.0f, 1.0f, 0.0f, 0.13333333f, 0.0f, 1.0f,
};

static float ozone_sidebar_gradient_bottom_hacking_the_kernel[16] = {
	0.0f, 0.0666666f,  0.0f, 1.0f, 0.0f, 0.0666666f,  0.0f, 1.0f,
	0.0f, 0.13333333f, 0.0f, 1.0f, 0.0f, 0.13333333f, 0.0f, 1.0f,
};

static float ozone_sidebar_gradient_top_twilight_zone[16] = {
	0.0078431f, 0.0f, 0.0156862f, 1.0f, 0.0078431f, 0.0f, 0.0156862f, 1.0f,
	0.0078431f, 0.0f, 0.0156862f, 1.0f, 0.0078431f, 0.0f, 0.0156862f, 1.0f,
};
...
static float ozone_sidebar_gradient_top_dracula[16] = {
	0.2666666f, 0.2784314f, 0.3529412f, 1.0f, 0.2666666f, 0.2784314f, 0.3529412f, 1.0f,
	0.2666666f, 0.2784314f, 0.3529412f, 1.0f, 0.2666666f, 0.2784314f, 0.3529412f, 1.0f,
};
...
static float ozone_sidebar_gradient_top_selenium[16] = {
	0.1019608f, 0.1019608f, 0.1019608f, 1.0f, 0.1019608f, 0.1019608f, 0.1019608f, 1.0f,
	0.1019608f, 0.1019608f, 0.1019608f, 1.0f, 0.1019608f, 0.1019608f, 0.1019608f, 1.0f,
};

static float ozone_sidebar_gradient_top_solarized_dark[16] = {
	0.0000000f, 0.1294118f, 0.1725490f, 1.0f, 0.0000000f, 0.1294118f, 0.1725490f, 1.0f,
	0.0000000f, 0.1294118f, 0.1725490f, 1.0f, 0.0000000f, 0.1294118f, 0.1725490f, 1.0f,
};
...
static float ozone_sidebar_gradient_top_solarized_light[16] = {
	1.0000000f, 1.0000000f, 0.9294118f, 1.0f, 1.0000000f, 1.0000000f, 0.9294118f, 1.0f,
	1.0000000f, 1.0000000f, 0.9294118f, 1.0f, 1.0000000f, 1.0000000f, 0.9294118f, 1.0f,
};
...
static float ozone_sidebar_background_gray_dark[16] = COLOR_HEX_TO_FLOAT(0x101010, 0.0f);

static float ozone_sidebar_background_gray_light[16] = COLOR_HEX_TO_FLOAT(0x202020, 0.0f);

static float ozone_sidebar_background_light[16] = {
	0.94f, 0.94f, 0.94f, 1.00f, 0.94f, 0.94f, 0.94f, 1.00f, 0.94f, 0.94f, 0.94f, 1.00f, 0.94f, 0.94f, 0.94f, 1.00f,
};

static float ozone_sidebar_background_dark[16] = {
	0.2f, 0.2f, 0.2f, 1.00f, 0.2f, 0.2f, 0.2f, 1.00f, 0.2f, 0.2f, 0.2f, 1.00f, 0.2f, 0.2f, 0.2f, 1.00f,
};
...
static float ozone_sidebar_background_hacking_the_kernel[16] = {
	0.0f, 0.1333333f, 0.0f, 1.0f, 0.0f, 0.1333333f, 0.0f, 1.0f,
	0.0f, 0.1333333f, 0.0f, 1.0f, 0.0f, 0.1333333f, 0.0f, 1.0f,
};
...
static float ozone_sidebar_background_purple_rain[16] = {
	0.0862745f, 0.0f, 0.1294117f, 1.0f, 0.0862745f, 0.0f, 0.1294117f, 1.0f,
	0.0862745f, 0.0f, 0.1294117f, 1.0f, 0.0862745f, 0.0f, 0.1294117f, 1.0f,
};

static float ozone_background_libretro_running_gray_dark[16] = COLOR_HEX_TO_FLOAT(0x101010, 1.0f);

static float ozone_background_libretro_running_gray_light[16] = COLOR_HEX_TO_FLOAT(0x202020, 1.0f);

static float ozone_background_libretro_running_light[16] = {0.690f, 0.690f, 0.690f, 0.75f,	0.690f, 0.690f,
															0.690f, 0.75f,	0.922f, 0.922f, 0.922f, 1.0f,
															0.922f, 0.922f, 0.922f, 1.0f};

static float ozone_background_libretro_running_dark[16] = {
	0.176f, 0.176f, 0.176f, 0.75f, 0.176f, 0.176f, 0.176f, 0.75f,
	0.178f, 0.178f, 0.178f, 1.0f,  0.178f, 0.178f, 0.178f, 1.0f,
};

static float ozone_background_libretro_running_nord[16] = {
	0.1803922f, 0.2039216f, 0.2509804f, 0.75f, 0.1803922f, 0.2039216f, 0.2509804f, 0.75f,
	0.1803922f, 0.2039216f, 0.2509804f, 1.0f,  0.1803922f, 0.2039216f, 0.2509804f, 1.0f,
};

static float ozone_background_libretro_running_gruvbox_dark[16] = {
	0.1568627f, 0.1568627f, 0.1568627f, 0.75f, 0.1568627f, 0.1568627f, 0.1568627f, 0.75f,
	0.1568627f, 0.1568627f, 0.1568627f, 1.0f,  0.1568627f, 0.1568627f, 0.1568627f, 1.0f,
};

static float ozone_background_libretro_running_boysenberry[16] = {
	0.27058823529f, 0.09803921568f, 0.14117647058f, 0.75f, 0.27058823529f, 0.09803921568f, 0.14117647058f, 0.75f,
	0.27058823529f, 0.09803921568f, 0.14117647058f, 0.75f, 0.27058823529f, 0.09803921568f, 0.14117647058f, 0.75f,
};

static float ozone_background_libretro_running_hacking_the_kernel[16] = {
	0.0f, 0.0666666f, 0.0f, 0.75f, 0.0f, 0.0666666f, 0.0f, 0.75f,
	0.0f, 0.0666666f, 0.0f, 1.0f,  0.0f, 0.0666666f, 0.0f, 1.0f,
};

static float ozone_background_libretro_running_twilight_zone[16] = {
	0.0078431f, 0.0f, 0.0156862f, 0.75f, 0.0078431f, 0.0f, 0.0156862f, 0.75f,
	0.0078431f, 0.0f, 0.0156862f, 1.0f,	 0.0078431f, 0.0f, 0.0156862f, 1.0f,
};

static float ozone_background_libretro_running_dracula[16] = {
	0.1568627f, 0.1647058f, 0.2117647f, 0.75f, 0.1568627f, 0.1647058f, 0.2117647f, 0.75f,
	0.1568627f, 0.1647058f, 0.2117647f, 1.0f,  0.1568627f, 0.1647058f, 0.2117647f, 1.0f,
};

static float ozone_background_libretro_running_selenium[16] = {
	0.1647059f, 0.1647059f, 0.1647059f, 1.0f, 0.1647059f, 0.1647059f, 0.1647059f, 1.0f,
	0.1647059f, 0.1647059f, 0.1647059f, 1.0f, 0.1647059f, 0.1647059f, 0.1647059f, 1.0f,
};
static float ozone_background_libretro_running_solarized_dark[16] = {
	0.0000000f, 0.1294118f, 0.1725490f, .85f, 0.0000000f, 0.1294118f, 0.1725490f, .85f,
	0.0000000f, 0.1294118f, 0.1725490f, 1.0f, 0.0000000f, 0.1294118f, 0.1725490f, 1.0f,
};

static float ozone_background_libretro_running_solarized_light[16] = {
	1.0000000f, 1.0000000f, 0.9294118f, 0.85f, 1.0000000f, 1.0000000f, 0.9294118f, 0.85f,
	1.0000000f, 1.0000000f, 0.9294118f, 1.0f,  1.0000000f, 1.0000000f, 0.9294118f, 1.0f,
};

static float ozone_background_libretro_running_purple_rain[16] = {
	0.0862745f, 0.0f, 0.1294117f, 0.75f, 0.0862745f, 0.0f, 0.1294117f, 0.75f,
	0.0862745f, 0.0f, 0.1294117f, 1.0f,	 0.0862745f, 0.0f, 0.1294117f, 1.0f,
};
...
static ozone_theme_t *ozone_themes[] = {
	&ozone_theme_light,			  &ozone_theme_dark,		&ozone_theme_nord,
	&ozone_theme_gruvbox_dark,	  &ozone_theme_boysenberry, &ozone_theme_hacking_the_kernel,
	&ozone_theme_twilight_zone,	  &ozone_theme_dracula,		&ozone_theme_solarized_dark,
	&ozone_theme_solarized_light, &ozone_theme_gray_dark,	&ozone_theme_gray_light,
	&ozone_theme_purple_rain,	  &ozone_theme_selenium,
};
...
static void ozone_restart_cursor_animation(ozone_handle_t *ozone) {
	...
	memcpy(ozone->theme_dynamic.cursor_border, ozone->theme->cursor_border_0,
...
static void ozone_set_color_theme(ozone_handle_t *ozone, unsigned color_theme) {
	...
	memcpy(ozone->theme_dynamic.selection_border, ozone->theme->selection_border,
	...
	memcpy(ozone->theme_dynamic.entries_border, ozone->theme->entries_border,
	...
	memcpy(ozone->theme_dynamic.message_background, ozone->theme->message_background,
...
static void ozone_set_background_running_opacity(ozone_handle_t *ozone, float framebuffer_opacity) {
#if USE_BG_GRADIENT
	static float background_running_alpha_top = 1.0f;
	static float background_running_alpha_bottom = 0.75f;
	float *background = ozone->theme->background_libretro_running;
	...
	background_running_alpha_top = (background_running_alpha_top > 1.0f)   ? 1.0f
								   : (background_running_alpha_top < 0.0f) ? 0.0f
																		   : background_running_alpha_top;

	background_running_alpha_bottom = (2.5f * framebuffer_opacity) - 1.5f;
	background_running_alpha_bottom = (background_running_alpha_bottom > 1.0f)	 ? 1.0f
									  : (background_running_alpha_bottom < 0.0f) ? 0.0f
...
static uintptr_t ozone_entries_icon_get_texture(ozone_handle_t *ozone, enum msg_hash_enums enum_idx,
												const char *enum_path, const char *enum_label, unsigned type,
												bool active) {
	switch(enum_idx) {
...
/* Thumbnailpack removal */
...
#ifdef HAVE_CHEEVOS
	if((type >= MENU_SETTINGS_CHEEVOS_START) && (type < MENU_SETTINGS_NETPLAY_ROOMS_START)) {
		char buffer[64];
	...
	if((type >= MENU_SETTINGS_INPUT_BEGIN) && (type <= MENU_SETTINGS_INPUT_DESC_KBD_END)) {
...
static bool ozone_reset_theme_textures(ozone_handle_t *ozone) {
	static const char *OZONE_THEME_TEXTURES_FILES[OZONE_THEME_TEXTURE_LAST] = {"switch.png", "check.png",
	...
	for(j = 0; j < ARRAY_SIZE(ozone_themes); j++) {
		...
		fill_pathname_join_special(theme_path, ozone->png_path, theme->name, sizeof(theme_path));

		for(i = 0; i < OZONE_THEME_TEXTURE_LAST; i++) {
			if(!gfx_display_reset_textures_list(OZONE_THEME_TEXTURES_FILES[i], theme_path, &theme->textures[i],
...
static float ozone_sidebar_get_scroll_y(ozone_handle_t *ozone, unsigned video_height) {
	...
	float current_selection_middle_onscreen = ozone->dimensions.header_height + ozone->dimensions.spacer_1px +
											  ozone->animations.scroll_y_sidebar + selected_position_y +
											  ozone->dimensions.sidebar_entry_height / 2.0f;
	float bottom_boundary = (float)video_height - (ozone->dimensions.header_height + ozone->dimensions.spacer_1px) -
...
static void ozone_draw_icon(gfx_display_t *p_disp, void *userdata, unsigned video_width, unsigned video_height,
							unsigned icon_width, unsigned icon_height, uintptr_t texture, float x, float y,
							unsigned width, unsigned height, float rotation, float scale_factor, float *color,
...
static void ozone_draw_cursor_slice(ozone_handle_t *ozone, gfx_display_t *p_disp, void *userdata, unsigned video_width,
									unsigned video_height, int x_offset, unsigned width, unsigned height, size_t y,
									float alpha, math_matrix_4x4 *mymat) {
	gfx_display_ctx_driver_t *dispctx = p_disp->dispctx;
	...
	gfx_display_draw_texture_slice(p_disp, userdata, video_width, video_height, slice_x, slice_y, slice_w, slice_h,
								   slice_new_w, slice_new_h, video_width, video_height,
								   ozone->theme_dynamic.cursor_alpha, offset, scale_factor,
								   ozone->theme->textures[OZONE_THEME_TEXTURE_CURSOR_NO_BORDER], mymat);

	/* Tainted border */
	gfx_display_draw_texture_slice(p_disp, userdata, video_width, video_height, slice_x, slice_y, slice_w, slice_h,
								   slice_new_w, slice_new_h, video_width, video_height,
								   ozone->theme_dynamic.cursor_border, offset, scale_factor,
								   ozone->textures[OZONE_TEXTURE_CURSOR_BORDER], mymat);

	if(dispctx && dispctx->blend_end)
		dispctx->blend_end(userdata);
}

static void ozone_draw_cursor_fallback(ozone_handle_t *ozone, gfx_display_t *p_disp, void *userdata,
									   unsigned video_width, unsigned video_height, int x_offset, unsigned width,
									   unsigned height, size_t y, float alpha) {
	static float last_alpha = 0.0f;
	...
	/* Fill */
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, x_offset - ozone->dimensions.spacer_3px, (int)y,
						  width + ozone->dimensions.spacer_3px * 2, height, video_width, video_height,
						  ozone->theme_dynamic.selection, NULL);

	/* Borders (can't do one single quad because of alpha) */

	/* Top */
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, x_offset - ozone->dimensions.spacer_5px,
						  (int)(y - ozone->dimensions.spacer_3px), width + 1 + ozone->dimensions.spacer_5px * 2,
						  ozone->dimensions.spacer_3px, video_width, video_height,
						  ozone->theme_dynamic.selection_border, NULL);

	/* Bottom */
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, x_offset - ozone->dimensions.spacer_5px,
						  (int)(y + height), width + 1 + ozone->dimensions.spacer_5px * 2, ozone->dimensions.spacer_3px,
						  video_width, video_height, ozone->theme_dynamic.selection_border, NULL);

	/* Left */
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, x_offset - ozone->dimensions.spacer_5px, (int)y,
						  ozone->dimensions.spacer_3px, height, video_width, video_height,
						  ozone->theme_dynamic.selection_border, NULL);

	/* Right */
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, x_offset + width + ozone->dimensions.spacer_3px,
						  (int)y, ozone->dimensions.spacer_3px, height, video_width, video_height,
						  ozone->theme_dynamic.selection_border, NULL);
}

static void ozone_draw_cursor(ozone_handle_t *ozone, gfx_display_t *p_disp, void *userdata, unsigned video_width,
							  unsigned video_height, int x_offset, unsigned width, unsigned height, size_t y,
							  float alpha, math_matrix_4x4 *mymat) {
	int new_x = x_offset;
	size_t new_y = y;
	...
	if((ozone->theme->name) &&
	   (ozone->flags & OZONE_FLAG_HAS_ALL_ASSETS || ozone->flags2 & OZONE_FLAG2_IGNORE_MISSING_ASSETS))
		ozone_draw_cursor_slice(ozone, p_disp, userdata, video_width, video_height, new_x, width, height, new_y, alpha,
								mymat);
	else
		ozone_draw_cursor_fallback(ozone, p_disp, userdata, video_width, video_height, new_x, width, height, new_y,
								   alpha);
}

static void ozone_draw_sidebar(ozone_handle_t *ozone, gfx_display_t *p_disp, gfx_animation_t *p_anim,
							   bool use_smooth_ticker, enum gfx_animation_ticker_type menu_ticker_type, void *userdata,
							   unsigned video_width, unsigned video_height, bool libretro_running,
							   float menu_framebuffer_opacity, math_matrix_4x4 *mymat) {
	static const enum msg_hash_enums ozone_system_tabs_value[OZONE_SYSTEM_TAB_LAST] = {
		MENU_ENUM_LABEL_VALUE_MAIN_MENU,   MENU_ENUM_LABEL_VALUE_SETTINGS_TAB,
		MENU_ENUM_LABEL_VALUE_HISTORY_TAB, MENU_ENUM_LABEL_VALUE_FAVORITES_TAB,
...
#endif
		MENU_ENUM_LABEL_VALUE_ADD_TAB,	   MENU_ENUM_LABEL_VALUE_CONTENTLESS_CORES_TAB,
#ifdef HAVE_LIBRETRODB
		MENU_ENUM_LABEL_VALUE_EXPLORE_TAB
#endif
	};
	static const unsigned ozone_system_tabs_icons[OZONE_SYSTEM_TAB_LAST] = {
		OZONE_TAB_TEXTURE_MAIN_MENU,	OZONE_TAB_TEXTURE_SETTINGS,
		OZONE_TAB_TEXTURE_HISTORY,		OZONE_TAB_TEXTURE_FAVORITES,
		OZONE_TAB_TEXTURE_MUSIC,
#if defined(HAVE_FFMPEG) || defined(HAVE_MPV)
		OZONE_TAB_TEXTURE_VIDEO,
#endif
		...
		OZONE_TAB_TEXTURE_NETWORK,
#endif
		OZONE_TAB_TEXTURE_SCAN_CONTENT, OZONE_TAB_TEXTURE_CONTENTLESS_CORES,
#ifdef HAVE_LIBRETRODB
		OZONE_TAB_TEXTURE_EXPLORE
#endif
	};
	...
	if(p_disp->dispctx && p_disp->dispctx->scissor_begin)
		gfx_display_scissor_begin(p_disp, userdata, video_width, video_height, 0,
								  ozone->dimensions.header_height + ozone->dimensions.spacer_1px,
								  (unsigned)ozone->dimensions_sidebar_width,
								  video_height - ozone->dimensions.header_height - ozone->dimensions.footer_height -
									  ozone->dimensions.spacer_1px);

	/* Background */
	sidebar_height = video_height - ozone->dimensions.header_height - ozone->dimensions.sidebar_gradient_height * 2 -
					 ozone->dimensions.footer_height;

	if(sidebar_height) {
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, ozone->sidebar_offset,
							  ozone->dimensions.header_height + ozone->dimensions.spacer_1px,
							  (unsigned)ozone->dimensions_sidebar_width, ozone->dimensions.sidebar_gradient_height,
							  video_width, video_height, ozone->theme->sidebar_top_gradient, NULL);
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, ozone->sidebar_offset,
							  ozone->dimensions.header_height + ozone->dimensions.spacer_1px +
								  ozone->dimensions.sidebar_gradient_height,
							  (unsigned)ozone->dimensions_sidebar_width, sidebar_height, video_width, video_height,
							  ozone->theme->sidebar_background, NULL);
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, ozone->sidebar_offset,
							  video_height - ozone->dimensions.footer_height -
								  ozone->dimensions.sidebar_gradient_height - ozone->dimensions.spacer_1px,
							  (unsigned)ozone->dimensions_sidebar_width,
							  ozone->dimensions.sidebar_gradient_height + ozone->dimensions.spacer_1px, video_width,
							  video_height, ozone->theme->sidebar_bottom_gradient, NULL);
	}
	...
	if(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR)
		ozone_draw_cursor(ozone, p_disp, userdata, video_width, video_height,
						  ...
						  selection_y + ozone->animations.scroll_y_sidebar, ozone->animations.cursor_alpha, mymat);

	if(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR_OLD)
		ozone_draw_cursor(
			ozone, p_disp, userdata, video_width, video_height,
			ozone->sidebar_offset + ozone->dimensions.sidebar_padding_horizontal + ozone->dimensions.spacer_3px,
			entry_width - ozone->dimensions.spacer_5px,
			ozone->dimensions.sidebar_entry_height + ozone->dimensions.spacer_1px,
			selection_old_y + ozone->animations.scroll_y_sidebar, 1 - ozone->animations.cursor_alpha, mymat);
	...
	for(i = 0; i < (unsigned)(ozone->system_tab_end + 1); i++) {
		...
		/* Icon */
		ozone_draw_icon(p_disp, userdata, video_width, video_height, ozone->dimensions.sidebar_entry_icon_size,
						ozone->dimensions.sidebar_entry_icon_size, ozone->tab_textures[icon],
						ozone->sidebar_offset + ozone->dimensions.sidebar_padding_horizontal +
							ozone->dimensions.sidebar_entry_icon_padding,
						y + ozone->dimensions.sidebar_entry_height / 2 - ozone->dimensions.sidebar_entry_icon_size / 2 +
							ozone->animations.scroll_y_sidebar,
						video_width, video_height, 0.0f, 1.0f, col, mymat);
		...
		if(!ozone->sidebar_collapsed) {
			...
			uint32_t text_color = selected ? COLOR_TEXT_ALPHA(ozone->theme->text_selected_rgba, text_alpha)
										   : COLOR_TEXT_ALPHA(ozone->theme->text_sidebar_rgba, text_alpha);
			gfx_display_draw_text(ozone->fonts.sidebar.font, title,
								  ozone->sidebar_offset + ozone->dimensions.sidebar_padding_horizontal +
								  ...
								  y + ozone->dimensions.sidebar_entry_height / 2.0f +
									  ozone->fonts.sidebar.line_centre_offset + ozone->animations.scroll_y_sidebar,
								  video_width, video_height, text_color, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f, true);
		}
	...
	if(horizontal_list_size > 0) {
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height,
							  ozone->sidebar_offset + ozone->dimensions.sidebar_padding_horizontal,
							  y + ozone->animations.scroll_y_sidebar, entry_width, ozone->dimensions.spacer_1px,
							  video_width, video_height, ozone->theme->entries_border, NULL);
		...
		for(i = 0; i < horizontal_list_size; i++) {
			...
			uint32_t text_color = COLOR_TEXT_ALPHA(
				(selected ? ozone->theme->text_selected_rgba : ozone->theme->text_sidebar_rgba), text_alpha);
			...
			/* Icon */
			ozone_draw_icon(p_disp, userdata, video_width, video_height, ozone->dimensions.sidebar_entry_icon_size,
							ozone->dimensions.sidebar_entry_icon_size, node->icon,
							ozone->sidebar_offset + ozone->dimensions.sidebar_padding_horizontal +
								ozone->dimensions.sidebar_entry_icon_padding,
							y + ozone->dimensions.sidebar_entry_height / 2 -
								ozone->dimensions.sidebar_entry_icon_size / 2 + ozone->animations.scroll_y_sidebar,
							video_width, video_height, 0.0f, 1.0f, col, mymat);
			...
			if(use_smooth_ticker) {
				 ...
				 * */
				ticker_smooth.field_width =
					(entry_width - ozone->dimensions.sidebar_entry_icon_size - 40 * scale_factor);
				...
				ticker.len = (entry_width - ozone->dimensions.sidebar_entry_icon_size - 40 * scale_factor) /
			...
			gfx_display_draw_text(
				ozone->fonts.sidebar.font, console_title,
				ticker_x_offset + ozone->sidebar_offset + ozone->dimensions.sidebar_padding_horizontal +
					ozone->dimensions.sidebar_entry_icon_padding * 2 + ozone->dimensions.sidebar_entry_icon_size,
				y + ozone->dimensions.sidebar_entry_height / 2 + ozone->fonts.sidebar.line_centre_offset +
					ozone->animations.scroll_y_sidebar,
				video_width, video_height, text_color, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f, true);
...
static bool ozone_is_main_menu_playlist(void *userdata) {
	...
	if((ozone->depth != 3) || (ozone->flags & OZONE_FLAG_IS_DB_MANAGER_LIST) ||
...
static void ozone_update_savestate_thumbnail_path(void *data, size_t i) {
	...
	strlcpy(ozone->prev_savestate_thumbnail_file_path, ozone->savestate_thumbnail_file_path,
		...
		if(!string_is_empty(entry.label)) {
			if(string_to_unsigned(entry.label) == MENU_ENUM_LABEL_STATE_SLOT ||
			   ...
			   string_is_equal(entry.label, msg_hash_to_str(MENU_ENUM_LABEL_SAVE_STATE))) {
				...
				if(state_slot < 0) {
					path[0] = '\0';
					_len = fill_pathname_join_delim(path, runloop_st->name.savestate, "auto", '.', sizeof(path));
				} else {
				...
				strlcpy(ozone->savestate_thumbnail_file_path, path, sizeof(ozone->savestate_thumbnail_file_path));

				ozone->flags |= OZONE_FLAG_WANT_THUMBNAIL_BAR | OZONE_FLAG_FULLSCREEN_THUMBNAILS_AVAILABLE;

				menu_update_fullscreen_thumbnail_label(
					ozone->fullscreen_thumbnail_label, sizeof(ozone->fullscreen_thumbnail_label),
					(ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU) ? true : false, NULL);
			}
...
static void ozone_update_savestate_thumbnail_image(void *data) {
	ozone_handle_t *ozone = (ozone_handle_t *)data;
	unsigned thumbnail_upscale_threshold = config_get_ptr()->uints.gfx_thumbnail_upscale_threshold;
	...
	if(string_is_empty(ozone->savestate_thumbnail_file_path))
		...
		if((ozone->thumbnails.savestate.status == GFX_THUMBNAIL_STATUS_UNKNOWN) ||
		   !string_is_equal(ozone->savestate_thumbnail_file_path, ozone->prev_savestate_thumbnail_file_path)) {
			gfx_thumbnail_request_file(ozone->savestate_thumbnail_file_path, &ozone->thumbnails.savestate,
...
static void ozone_entries_update_thumbnail_bar(ozone_handle_t *ozone, bool savestate_thumbnail, bool is_playlist,
	...
	if((!(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR)) &&
	   ((!(ozone->show_thumbnail_bar)) || (ozone->flags & OZONE_FLAG_PENDING_HIDE_THUMBNAIL_BAR)) &&
	   ((ozone->flags & OZONE_FLAG_WANT_THUMBNAIL_BAR) || (ozone->flags & OZONE_FLAG_IS_STATE_SLOT))) {
		if(allow_animation) {
			entry.cb = NULL;
			entry.userdata = NULL;
	...
	/* Hide it */
			...
			((ozone->show_thumbnail_bar) && (!(ozone->flags & OZONE_FLAG_WANT_THUMBNAIL_BAR)) &&
			 (!(ozone->flags & OZONE_FLAG_IS_STATE_SLOT)))) {
		if(allow_animation) {
...
static bool ozone_want_collapse(ozone_handle_t *ozone, bool ozone_collapse_sidebar, bool is_playlist) {
	return (ozone_collapse_sidebar) || (is_playlist && (!(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR)));
}

static void ozone_sidebar_update_collapse(ozone_handle_t *ozone, bool ozone_collapse_sidebar, bool allow_animation) {
	...
	if((collapse && ozone->sidebar_collapsed) || (!collapse && !ozone->sidebar_collapsed))
		goto end;
	...
	ozone_entries_update_thumbnail_bar(ozone, config_get_ptr()->bools.savestate_thumbnail_enable, is_playlist,
									   allow_animation);
}

static void ozone_go_to_sidebar(ozone_handle_t *ozone, bool ozone_collapse_sidebar, uintptr_t tag) {
	struct gfx_animation_ctx_entry entry;
...
static void ozone_update_content_metadata(ozone_handle_t *ozone) {
	...
	enum playlist_sublabel_last_played_style_type runtime_last_played_style =
		(enum playlist_sublabel_last_played_style_type)settings->uints.playlist_sublabel_last_played_style;
	enum playlist_sublabel_last_played_date_separator_type runtime_date_separator =
	...
	if(!string_is_empty(menu_st->thumbnail_path_data->content_core_name)) {
		if(string_is_equal(menu_st->thumbnail_path_data->content_core_name, "imageviewer") ||
		   string_is_equal(menu_st->thumbnail_path_data->content_core_name, "musicplayer") ||
		   string_is_equal(menu_st->thumbnail_path_data->content_core_name, "movieplayer"))
			ozone->flags2 |= OZONE_FLAG2_SELECTION_CORE_IS_VIEWER;
		else
			ozone->flags2 &= ~OZONE_FLAG2_SELECTION_CORE_IS_VIEWER;
	} else
	...
	if((playlist && ((ozone->flags & OZONE_FLAG_IS_PLAYLIST) || (ozone->flags & OZONE_FLAG_IS_EXPLORE_LIST) ||
	   ...
	   ((ozone->flags & OZONE_FLAG_IS_DB_MANAGER_LIST) && ozone->depth == 4)) {
...
#if defined(HAVE_LIBRETRODB)
		else if(list && (selection < list_size) && (ozone->flags & OZONE_FLAG_IS_EXPLORE_LIST)) {
			playlist_index = menu_explore_get_entry_playlist_index(list->list[selection].type, &playlist, &entry, list,
																   &selection, &list_size);
		...
		else if(list && (selection < list_size) && (list->list[selection].type == FILE_TYPE_RPL_ENTRY)) {
		...
		if(show_entry_idx) {
			unsigned long _entry = menu_entries_search_get_terms() ? (unsigned long)(menu_st->selection_ptr + 1)
			...
			snprintf(ozone->selection_entry_enumeration, sizeof(ozone->selection_entry_enumeration),
					 msg_hash_to_str(MENU_ENUM_LABEL_VALUE_CONTENT_INFO_ENTRY_IDX), _entry, (unsigned long)list_size);
		...
		_len = strlcpy(ozone->selection_core_name, msg_hash_to_str(MENU_ENUM_LABEL_VALUE_PLAYLIST_SUBLABEL_CORE),
					   sizeof(ozone->selection_core_name));
		_len += strlcpy(ozone->selection_core_name + _len, " ", sizeof(ozone->selection_core_name) - _len);
		...
		if(!scroll_content_metadata) {
			...
			(ozone->word_wrap)(ozone->selection_core_name, sizeof(ozone->selection_core_name), tmpstr, _len,
		...
		if(entry) {
			if((entry->runtime_status == PLAYLIST_RUNTIME_UNKNOWN) || (ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU))
				runtime_update_playlist(playlist, playlist_index, directory_runtime_log, directory_playlist,
										(runtime_type == PLAYLIST_RUNTIME_PER_CORE), runtime_last_played_style,
			...
			size_t _len =
				strlcpy(ozone->selection_playtime, msg_hash_to_str(MENU_ENUM_LABEL_VALUE_PLAYLIST_SUBLABEL_RUNTIME),
						sizeof(ozone->selection_playtime));
			_len += strlcpy(ozone->selection_playtime + _len, " ", sizeof(ozone->selection_playtime) - _len);
			...
			_len += strlcpy(ozone->selection_lastplayed + _len, " ", sizeof(ozone->selection_lastplayed) - _len);
		...
		if(!scroll_content_metadata) {
			...
			(ozone->word_wrap)(ozone->selection_lastplayed, sizeof(ozone->selection_lastplayed), tmpstr, _len, 30, 100,
							   0);
...
static void ozone_tab_set_selection(void *data) {
	...
	if(ozone && !(ozone->flags2 & OZONE_FLAG2_LAST_POINTER_IN_SIDEBAR)) {
...
static void ozone_leave_sidebar(ozone_handle_t *ozone, bool ozone_collapse_sidebar, uintptr_t tag,
...
static void ozone_list_cache(void *data, enum menu_list_type type, unsigned action) {
	...
	for(i = 0; i < entries_end; i++) {
		...
		if(y + ozone->animations.scroll_y + node->height + 20 * scale_factor <
		   ozone->dimensions.header_height + ozone->dimensions.entry_padding_vertical) {
			first++;
			goto text_iterate;
...
static void ozone_sidebar_goto(ozone_handle_t *ozone, size_t new_selection) {
	static const enum msg_hash_enums ozone_system_tabs_idx[OZONE_SYSTEM_TAB_LAST] = {
		MENU_ENUM_LABEL_MAIN_MENU,	 MENU_ENUM_LABEL_SETTINGS_TAB,
		MENU_ENUM_LABEL_HISTORY_TAB, MENU_ENUM_LABEL_FAVORITES_TAB,
...
#endif
		MENU_ENUM_LABEL_ADD_TAB,	 MENU_ENUM_LABEL_CONTENTLESS_CORES_TAB,
#ifdef HAVE_LIBRETRODB
		MENU_ENUM_LABEL_EXPLORE_TAB
#endif
	};
	static const enum menu_settings_type ozone_system_tabs_type[OZONE_SYSTEM_TAB_LAST] = {
		MENU_SETTINGS,	  MENU_SETTINGS_TAB,		  MENU_HISTORY_TAB, MENU_FAVORITES_TAB, MENU_MUSIC_TAB,
#if defined(HAVE_FFMPEG) || defined(HAVE_MPV)
		MENU_VIDEO_TAB,
#endif
#ifdef HAVE_IMAGEVIEWER
		...
		MENU_NETPLAY_TAB,
#endif
		MENU_ADD_TAB,	  MENU_CONTENTLESS_CORES_TAB,
#ifdef HAVE_LIBRETRODB
		MENU_EXPLORE_TAB
#endif
	};
	...
	if(new_selection > ozone->system_tab_end)
		...
		ozone_change_tab(ozone, ozone_system_tabs_idx[ozone->tabs[new_selection]],
						 ozone_system_tabs_type[ozone->tabs[new_selection]]);
}

static void ozone_sidebar_entries_build_scroll_indices(ozone_handle_t *ozone) {
	size_t i = 0;
	const char *path =
		ozone->horizontal_list.list[0].alt ? ozone->horizontal_list.list[0].alt : ozone->horizontal_list.list[0].path;
	...
	for(i = 1; i < ozone->horizontal_list.size; i++) {
		int first;
		path = ozone->horizontal_list.list[i].alt ? ozone->horizontal_list.list[i].alt
...
static void ozone_refresh_sidebars(ozone_handle_t *ozone, bool ozone_collapse_sidebar, unsigned video_height) {
...
static void ozone_init_horizontal_list(ozone_handle_t *ozone, settings_t *settings) {
	...
	for(i = 0; i < list_size; i++) {
		...
		fill_pathname(playlist_file_noext, path_basename(playlist_file), "", sizeof(playlist_file_noext));
	...
	if(ozone_truncate_playlist_name && ozone_sort_after_truncate && (list_size > 0))
...
static void ozone_context_reset_horizontal_list(ozone_handle_t *ozone) {
	...
	for(i = 0; i < list_size; i++) {
		...
		if(string_ends_with_size(path, ".lpl", strlen(path), STRLEN_CONST(".lpl"))) {
			...
			__len = fill_pathname_join_special(texturepath, ozone->icons_path, sysname, sizeof(texturepath));
			__len += strlcpy(texturepath + __len, ".png", sizeof(texturepath) - __len);

			/* If the playlist icon doesn't exist, return default */
			if(!path_is_valid(texturepath))
				__len = fill_pathname_join_special(texturepath, ozone->icons_path, "default.png", sizeof(texturepath));
			...
			fill_pathname_join_special(texturepath, ozone->icons_path, sysname, sizeof(texturepath));

			/* If the content icon doesn't exist, return default-content */
			if(!path_is_valid(texturepath))
				fill_pathname_join_delim(texturepath, ozone->icons_path_default, "content.png", '-',
										 sizeof(texturepath));
			...
			/* Console name */
			console_name = ozone->horizontal_list.list[i].alt ? ozone->horizontal_list.list[i].alt
															  : ozone->horizontal_list.list[i].path;
...
static void ozone_refresh_horizontal_list(ozone_handle_t *ozone, settings_t *settings) {
	struct menu_state *menu_st = menu_state_get_ptr();
...
static void ozone_draw_entry_value(ozone_handle_t *ozone, gfx_display_t *p_disp, void *userdata, unsigned video_width,
								   unsigned video_height, char *value, unsigned x, unsigned y, uint32_t alpha_uint32,
								   menu_entry_t *entry, math_matrix_4x4 *mymat) {
	...
	if(entry->flags & MENU_ENTRY_FLAG_CHECKED) {
		...
		if(dispctx && dispctx->blend_begin)
			dispctx->blend_begin(userdata);
		ozone_draw_icon(p_disp, userdata, video_width, video_height, 30 * scale_factor, 30 * scale_factor,
						ozone->theme->name ? ozone->theme->textures[OZONE_THEME_TEXTURE_CHECK]
										   : ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_CHECKMARK],
						x - 20 * scale_factor, y - 22 * scale_factor, video_width, video_height, 0.0f, 1.0f, col,
						mymat);
		if(dispctx && dispctx->blend_end)
			dispctx->blend_end(userdata);
		return;
	   ...
	   string_is_equal(value, msg_hash_to_str(MENU_ENUM_LABEL_VALUE_OFF)))
		...
		if(!string_is_empty(entry->value)) {
			if(string_is_equal(entry->value, "..."))
				return;
			if(string_starts_with_size(entry->value, "(", STRLEN_CONST("(")) && string_ends_with(entry->value, ")")) {
				if(string_is_equal(entry->value, "(PRESET)") || string_is_equal(entry->value, "(SHADER)") ||
				   string_is_equal(entry->value, "(COMP)") || string_is_equal(entry->value, "(CORE)") ||
				   string_is_equal(entry->value, "(MOVIE)") || string_is_equal(entry->value, "(MUSIC)") ||
				   string_is_equal(entry->value, "(DIR)") || string_is_equal(entry->value, "(RDB)") ||
				   string_is_equal(entry->value, "(CURSOR)") || string_is_equal(entry->value, "(CFILE)") ||
				   string_is_equal(entry->value, "(FILE)") || string_is_equal(entry->value, "(IMAGE)"))
					return;
			}
		}
	...
	if(do_draw_text) {
		gfx_display_draw_text(ozone->fonts.entries_label.font, value, x, y, video_width, video_height,
							  ...
							  TEXT_ALIGN_RIGHT, 1.0f, false, 1.0f, false);
	} else
		gfx_display_draw_text(
			ozone->fonts.entries_label.font,
			(switch_is_on ? msg_hash_to_str(MENU_ENUM_LABEL_VALUE_ON) : msg_hash_to_str(MENU_ENUM_LABEL_VALUE_OFF)), x,
			y, video_width, video_height,
			switch_is_on ? COLOR_TEXT_ALPHA(ozone->theme->text_selected_rgba, alpha_uint32)
						 : COLOR_TEXT_ALPHA(ozone->theme->text_selected_rgba, alpha_uint32 >> 1),
			TEXT_ALIGN_RIGHT, 1.0f, false, 1.0f, false);
}

static void ozone_draw_no_thumbnail_available(ozone_handle_t *ozone, gfx_display_t *p_disp, void *userdata,
											  unsigned video_width, unsigned video_height, unsigned x_position,
											  unsigned y_position, unsigned view_width, unsigned view_height,
											  bool draw_text, math_matrix_4x4 *mymat) {
	gfx_display_ctx_driver_t *dispctx = p_disp->dispctx;
	...
	if(dispctx) {
		...
		if(dispctx->blend_begin)
			dispctx->blend_begin(userdata);
		if(dispctx->draw)
			ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
							ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_IMAGE],
							x_position + ((view_width - icon_size) / 2),
							video_height - y_position - icon_size - ((view_height - icon_size) / 2), video_width,
							video_height, 0.0f, 1.0f, col, mymat);
	...
	gfx_display_draw_text(ozone->fonts.footer.font, msg_hash_to_str(MSG_NO_THUMBNAIL_AVAILABLE),
						  x_position + (view_width / 2), video_height - y_position - ((view_height - icon_size) / 2),
						  video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_CENTER, 1.0f, false, 1.0f,
						  true);
}

static void ozone_content_metadata_line(unsigned video_width, unsigned video_height, ozone_handle_t *ozone, unsigned *y,
										unsigned column_x, const char *text, uint32_t color, uint8_t lines_count) {
	if(*y + (lines_count * (unsigned)ozone->fonts.footer.line_height) > video_height - ozone->dimensions.footer_height)
		return;

	gfx_display_draw_text(ozone->fonts.footer.font, text, column_x, *y + ozone->fonts.footer.line_ascender, video_width,
						  video_height, color, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f, true);
...
static void ozone_update_scroll(ozone_handle_t *ozone, bool allow_animation, ozone_node_t *node) {
	...
	current_selection_middle_onscreen = ozone->dimensions.header_height + ozone->dimensions.entry_padding_vertical +
										ozone->animations.scroll_y + node->position_y + node->height / 2;

	bottom_boundary = video_info_height - ozone->dimensions.header_height - ozone->dimensions.spacer_1px -
					  ozone->dimensions.footer_height;
...
static int ozone_get_sublabel_max_width(ozone_handle_t *ozone, unsigned video_info_width, unsigned entry_padding) {
...
static void ozone_compute_entries_position(ozone_handle_t *ozone, bool savestate_thumbnail_enable,
	...
	if(show_thumbnail_bar != want_thumbnail_bar) {
		if(!((ozone->flags & OZONE_FLAG_PENDING_HIDE_THUMBNAIL_BAR) && (ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU)))
			ozone_entries_update_thumbnail_bar(ozone, savestate_thumbnail_enable, false, false);
	}
	...
	for(i = 0; i < entries_end; i++) {
		...
		/* Empty playlist detection:
		   ...
		   OZONE_ENTRIES_ICONS_TEXTURE_CORE_INFO */
		if((ozone->flags & OZONE_FLAG_IS_PLAYLIST) && (entries_end == 1)) {
			uintptr_t tex =
				ozone_entries_icon_get_texture(ozone, entry.enum_idx, entry.path, entry.label, entry.type, false);
...
static void ozone_draw_entries(ozone_handle_t *ozone, gfx_display_t *p_disp, gfx_animation_t *p_anim,
							   settings_t *settings, void *userdata, unsigned video_width, unsigned video_height,
							   unsigned selection, unsigned selection_old, file_list_t *selection_buf, float alpha,
							   float scroll_y, bool is_playlist, math_matrix_4x4 *mymat) {
	size_t i;
	...
	int entry_padding = old_list ? ozone_get_entries_padding_old_list(ozone) : ozone_get_entries_padding(ozone);
	int sublabel_max_width = 0;
	float scale_factor = ozone->last_scale_factor;
	gfx_display_ctx_driver_t *dispctx = p_disp->dispctx;
	size_t entries_end = selection_buf ? selection_buf->size : 0;
	size_t y =
		ozone->dimensions.header_height + ozone->dimensions.spacer_1px + ozone->dimensions.entry_padding_vertical;
	float sidebar_offset = ozone->sidebar_offset;
	unsigned entry_width = video_width - (unsigned)ozone->dimensions_sidebar_width - ozone->sidebar_offset -
						   entry_padding * 2 - ozone->animations.thumbnail_bar_position;
	...
	if(ozone->show_thumbnail_bar && ozone->depth > 1) {
		...
		if((ozone->flags & OZONE_FLAG_IS_PLAYLIST) && (!(ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU))) {
	...
	for(i = 0; i < entries_end; i++) {
		...
		/* Borders */
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, border_start_x, border_start_y, entry_width,
							  ozone->dimensions.spacer_1px, video_width, video_height,
							  ozone->theme_dynamic.entries_border, NULL);
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, border_start_x,
							  border_start_y + button_height, entry_width, ozone->dimensions.spacer_1px, video_width,
							  video_height, ozone->theme_dynamic.entries_border, NULL);
	...
	if(!(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR))
		ozone_draw_cursor(ozone, p_disp, userdata, video_width, video_height,
						  ...
						  entry_width - ozone->dimensions.spacer_5px, button_height + ozone->dimensions.spacer_1px,
						  selection_y + scroll_y, ozone->animations.cursor_alpha * alpha, mymat);

	/* Old */
	if(!(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR_OLD))
		ozone_draw_cursor(ozone, p_disp, userdata, video_width, video_height,
						  (unsigned)ozone->dimensions_sidebar_width + x_offset + entry_padding +
							  ozone->dimensions.spacer_3px,
						  /* TODO/FIXME - undefined behavior reported by ASAN -
						   ...
						   * */
						  entry_width - ozone->dimensions.spacer_5px, button_height + ozone->dimensions.spacer_1px,
						  old_selection_y + scroll_y, (1 - ozone->animations.cursor_alpha) * alpha, mymat);
	...
	for(i = 0; i < entries_end; i++) {
		...
		MENU_ENTRY_INITIALIZE(entry);
		entry.flags |=
			MENU_ENTRY_FLAG_RICH_LABEL_ENABLED | MENU_ENTRY_FLAG_VALUE_ENABLED | MENU_ENTRY_FLAG_SUBLABEL_ENABLED;
		...
		if(use_smooth_ticker) {
			...
			ticker_smooth.field_width =
				entry_width - entry_padding - (10 * scale_factor) - ozone->dimensions.entry_icon_padding;
			...
			ticker.len = (entry_width - entry_padding - (10 * scale_factor) - ozone->dimensions.entry_icon_padding) /
		...
		if(ozone->flags & OZONE_FLAG_EMPTY_PLAYLIST) {
			...
			unsigned text_width =
				font_driver_get_message_width(ozone->fonts.entries_label.font, rich_label, strlen(rich_label), 1.0f);
			x_offset = (video_info_width - (unsigned)ozone->dimensions_sidebar_width - entry_padding * 2) / 2 -
					   (text_width / 2) - (60 * scale_factor);
		...
		if(menu_show_sublabels) {
			if(node->wrap && !string_is_empty(sublabel_str)) {
				...
				(ozone->word_wrap)(wrapped_sublabel_str, sizeof(wrapped_sublabel_str), sublabel_str,
								   strlen(sublabel_str), sublabel_max_width / ozone->fonts.entries_sublabel.glyph_width,
								   ozone->fonts.entries_sublabel.wideglyph_width, 0);
		...
		/* Icon */
		texture =
			ozone_entries_icon_get_texture(ozone, entry.enum_idx, entry.path, entry.label, entry.type, entry_selected);

		if(texture) {
			/* Console specific icons */
			if(entry.type == FILE_TYPE_RPL_ENTRY && ozone->categories_selection_ptr > ozone->system_tab_end) {
				ozone_node_t *sidebar_node = (ozone_node_t *)file_list_get_userdata_at_offset(
					&ozone->horizontal_list, ozone->categories_selection_ptr - ozone->system_tab_end - 1);
			...
			/* Playlist manager icons */
				...
				if(string_is_equal(entry.rich_label, msg_hash_to_str(MENU_ENUM_LABEL_VALUE_HISTORY_TAB)))
					...
					for(offset = 0; offset < ozone->horizontal_list.size; offset++) {
						char playlist_file_noext[NAME_MAX_LENGTH];
						fill_pathname(playlist_file_noext, ozone->horizontal_list.list[offset].path, "",
			...
			/* "Main Menu" playlists */
				...
				if(ozone_is_main_menu_playlist(ozone)) {
					...
					if(pl_entry && !string_is_empty(pl_entry->db_name) &&
					...
					ozone_node_t *sidebar_node = (ozone_node_t *)(ozone->horizontal_list.size)
			...
			else if(entry.type == FILE_TYPE_RPL_ENTRY && show_history_icons != PLAYLIST_SHOW_HISTORY_ICONS_DEFAULT) {
				switch(ozone->tabs[ozone->categories_selection_ptr]) {
					case OZONE_SYSTEM_TAB_MAIN:
					case OZONE_SYSTEM_TAB_HISTORY:
					case OZONE_SYSTEM_TAB_FAVORITES: {
			...
			if(dispctx) {
				if(dispctx->blend_begin)
					dispctx->blend_begin(userdata);
				if(dispctx->draw)
					ozone_draw_icon(p_disp, userdata, video_width, video_height, ozone->dimensions.entry_icon_size,
									ozone->dimensions.entry_icon_size, texture,
									ozone->dimensions_sidebar_width + x_offset + entry_padding +
										ozone->dimensions.entry_icon_padding,
									y + scroll_y + ozone->dimensions.entry_height / 2 -
										ozone->dimensions.entry_icon_size / 2,
									video_width, video_height, 0.0f, 1.0f, icon_color, mymat);
				if(dispctx->blend_end)
					dispctx->blend_end(userdata);
			}
		...
		/* Draw text */
		gfx_display_draw_text(
			ozone->fonts.entries_label.font, rich_label,
			ticker_x_offset + text_offset + (unsigned)ozone->dimensions_sidebar_width + x_offset + entry_padding +
				ozone->dimensions.entry_icon_size + ozone->dimensions.entry_icon_padding * 2,
			y + ozone->dimensions.entry_height / 2.0f + ozone->fonts.entries_label.line_centre_offset + scroll_y,
			video_width, video_height, COLOR_TEXT_ALPHA(ozone->theme->text_rgba, alpha_uint32), TEXT_ALIGN_LEFT, 1.0f,
			false, 1.0f, false);

		if(menu_show_sublabels) {
			if(!string_is_empty(sublabel_str))
				gfx_display_draw_text(ozone->fonts.entries_sublabel.font, sublabel_str,
									  (unsigned)ozone->dimensions_sidebar_width + x_offset + entry_padding +
										  ozone->dimensions.entry_icon_padding,
									  y + ozone->dimensions.entry_height - ozone->dimensions.spacer_1px +
										  (node->height - ozone->dimensions.entry_height -
										   (node->sublabel_lines * ozone->fonts.entries_sublabel.line_height)) /
											  2.0f +
										  ozone->fonts.entries_sublabel.line_ascender + scroll_y,
									  video_width, video_height,
									  COLOR_TEXT_ALPHA(ozone->theme->text_sublabel_rgba, alpha_uint32), TEXT_ALIGN_LEFT,
		...
		if(use_smooth_ticker) {
			ticker_smooth.selected = entry_selected && (!(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR));
			ticker_smooth.field_width =
				(entry_width - ozone->dimensions.entry_icon_size - ozone->dimensions.entry_icon_padding * 2 -
		...
		ozone_draw_entry_value(ozone, p_disp, userdata, video_width, video_height, entry_value_ticker,
							   value_x_offset + (unsigned)ozone->dimensions_sidebar_width + entry_padding + x_offset +
								   entry_width - ozone->dimensions.entry_icon_padding,
							   y + ozone->dimensions.entry_height / 2 + ozone->fonts.entries_label.line_centre_offset +
								   scroll_y,
							   alpha_uint32, &entry, mymat);
...
static void ozone_draw_thumbnail_bar(ozone_handle_t *ozone, struct menu_state *menu_st, gfx_display_t *p_disp,
									 gfx_animation_t *p_anim, settings_t *settings, void *userdata,
									 unsigned video_width, unsigned video_height, bool libretro_running,
									 float menu_framebuffer_opacity, math_matrix_4x4 *mymat) {
	...
	unsigned sidebar_height = video_height - ozone->dimensions.header_height -
							  ozone->dimensions.sidebar_gradient_height * 2 - ozone->dimensions.footer_height;
	unsigned x_position =
		video_width - (unsigned)ozone->animations.thumbnail_bar_position - ozone->dimensions.sidebar_entry_icon_padding;
	int thumbnail_x_position = x_position + ozone->dimensions.sidebar_entry_icon_padding;
	unsigned thumbnail_height = (video_height - ozone->dimensions.header_height - ozone->dimensions.spacer_2px -
								 ozone->dimensions.footer_height - (ozone->dimensions.sidebar_entry_icon_padding * 3)) /
								2;
	float scale_factor = ozone->last_scale_factor;
	gfx_display_ctx_driver_t *dispctx = p_disp->dispctx;
	...
	/* Background */
	if(thumbnail_height) {
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, x_position,
							  ozone->dimensions.header_height + ozone->dimensions.spacer_1px,
							  (unsigned)ozone->animations.thumbnail_bar_position +
								  ozone->dimensions.sidebar_entry_icon_padding,
							  ozone->dimensions.sidebar_gradient_height, video_width, video_height,
							  ozone->theme->sidebar_top_gradient, NULL);
		gfx_display_draw_quad(
			p_disp, userdata, video_width, video_height, x_position,
			...
			sidebar_height, video_width, video_height, ozone->theme->sidebar_background, NULL);
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, x_position,
							  video_height - ozone->dimensions.footer_height -
								  ozone->dimensions.sidebar_gradient_height - ozone->dimensions.spacer_1px,
							  (unsigned)ozone->animations.thumbnail_bar_position +
	...
	/* Thumbnails */
	show_right_thumbnail = (ozone->thumbnails.right.status != GFX_THUMBNAIL_STATUS_MISSING) &&
						   gfx_thumbnail_is_enabled(menu_st->thumbnail_path_data, GFX_THUMBNAIL_RIGHT);
	show_left_thumbnail = (ozone->thumbnails.left.status != GFX_THUMBNAIL_STATUS_MISSING) &&
	...
	if(((ozone->flags & OZONE_FLAG_WANT_THUMBNAIL_BAR) && !string_is_empty(ozone->savestate_thumbnail_file_path)) ||
	   (ozone->flags & OZONE_FLAG_IS_STATE_SLOT)) {
		...
		show_right_thumbnail = ozone->thumbnails.savestate.status == GFX_THUMBNAIL_STATUS_AVAILABLE ||
	...
	if(ozone->flags2 & OZONE_FLAG2_SELECTION_CORE_IS_VIEWER) {
		right_thumbnail_y_position = ozone->dimensions.header_height + (thumbnail_height / 2) +
		...
		right_thumbnail_y_position = ozone->dimensions.header_height + ozone->dimensions.spacer_1px +
									 ozone->dimensions.sidebar_entry_icon_padding;
	...
	if((ozone->flags2 & OZONE_FLAG2_SELECTION_CORE_IS_VIEWER) && (!show_right_thumbnail && !show_left_thumbnail)) {
		float background_color[16] = {
			0.05f, 0.05f, 0.05f, 1.0f, 0.05f, 0.05f, 0.05f, 1.0f, 0.05f, 0.05f, 0.05f, 1.0f, 0.05f, 0.05f, 0.05f, 1.0f,
		};

		/* Darken background */
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, thumbnail_x_position,
							  right_thumbnail_y_position, thumbnail_width, thumbnail_height, video_width, video_height,
							  background_color, NULL);

		ozone_draw_no_thumbnail_available(ozone, p_disp, userdata, video_width, video_height, thumbnail_x_position,
										  right_thumbnail_y_position, thumbnail_width, thumbnail_height, false, mymat);
		return;
	}
	...
	if(show_right_thumbnail) {
		gfx_thumbnail_draw(userdata, video_width, video_height,
						   ...
						   (float)thumbnail_x_position, (float)right_thumbnail_y_position, thumbnail_width,
						   thumbnail_height, right_thumbnail_alignment, 1.0f, 1.0f, NULL);
		ozone->flags &= ~OZONE_FLAG_NO_THUMBNAIL_AVAILABLE;
	}
	 ...
	 *   display 'no thumbnail available' message */
		...
		ozone_draw_no_thumbnail_available(ozone, p_disp, userdata, video_width, video_height, thumbnail_x_position,
										  right_thumbnail_y_position + thumbnail_height, thumbnail_width,
										  thumbnail_height, false, mymat);
	}
	...
	bottom_row_y_position = ozone->dimensions.header_height + ozone->dimensions.spacer_1px + thumbnail_height +
							(ozone->dimensions.sidebar_entry_icon_padding * 2);
	...
	if(show_left_thumbnail) {
		...
		gfx_thumbnail_draw(userdata, video_width, video_height, &ozone->thumbnails.left, (float)thumbnail_x_position,
						   (float)left_thumbnail_y_position, thumbnail_width, thumbnail_height,
						   left_thumbnail_alignment, left_thumbnail_alpha, 1.0f, NULL);
		ozone->flags &= ~OZONE_FLAG_NO_THUMBNAIL_AVAILABLE;
	}
	...
	if((!(ozone->flags2 & OZONE_FLAG2_SELECTION_CORE_IS_VIEWER)) &&
	   (!show_left_thumbnail || !show_right_thumbnail || (ozone->animations.left_thumbnail_alpha < 1.0f))) {
		...
		bool metadata_override_enabled =
			show_left_thumbnail && show_right_thumbnail && (ozone->animations.left_thumbnail_alpha < 1.0f);
		float metadata_alpha = metadata_override_enabled ? (1.0f - ozone->animations.left_thumbnail_alpha) : 1.0f;
		uint32_t text_color = COLOR_TEXT_ALPHA(ozone->theme->text_rgba, (uint32_t)(metadata_alpha * 255.0f));
		...
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, x_position + separator_padding, y,
							  sidebar_width - separator_padding * 2, ozone->dimensions.spacer_1px, video_width,
							  video_height, ozone->theme_dynamic.entries_border, NULL);
		...
		if(scroll_content_metadata) {
			...
			if(show_entry_idx) {
				...
				ozone_content_metadata_line(video_width, video_height, ozone, &y, ticker_x_offset + column_x,
											ticker_buf, text_color, 1);
			}
			...
			/* Entry enumeration */
			if(show_entry_idx)
				ozone_content_metadata_line(video_width, video_height, ozone, &y, column_x,
											ozone->selection_entry_enumeration, text_color,
											ozone_count_lines(ozone->selection_entry_enumeration));

			/* Core association */
			if(show_entry_core)
				ozone_content_metadata_line(video_width, video_height, ozone, &y, column_x, ozone->selection_core_name,
											text_color, ozone->selection_core_name_lines);

			/* Playtime */
			if(show_entry_playtime)
				ozone_content_metadata_line(video_width, video_height, ozone, &y, column_x, ozone->selection_playtime,
											text_color, ozone_count_lines(ozone->selection_playtime));

			/* Last played */
			if(show_entry_last_played)
				ozone_content_metadata_line(video_width, video_height, ozone, &y, column_x, ozone->selection_lastplayed,
											text_color, ozone->selection_lastplayed_lines);
		}
			...
			if(dispctx) {
				...
				if(dispctx->draw)
					ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
									...
									video_height - ozone->dimensions.footer_height -
										ozone->dimensions.sidebar_entry_icon_padding - icon_size,
									video_width, video_height, 0.0f, 1.0f, col, mymat);
				if(dispctx->blend_end)
					dispctx->blend_end(userdata);
			}
...
static void ozone_draw_backdrop(void *userdata, void *disp_data, unsigned video_width, unsigned video_height,
								float alpha) {
	static float ozone_backdrop[16] = {
		0.00, 0.00, 0.00, 0.75, 0.00, 0.00, 0.00, 0.75, 0.00, 0.00, 0.00, 0.75, 0.00, 0.00, 0.00, 0.75,
	};
	static float last_alpha = 0.0f;
	...
	gfx_display_draw_quad((gfx_display_t *)disp_data, userdata, video_width, video_height, 0, 0, video_width,
						  video_height, video_width, video_height, ozone_backdrop, NULL);
}

static void ozone_draw_osk(ozone_handle_t *ozone, void *userdata, void *disp_userdata, unsigned video_width,
						   unsigned video_height, const char *label, const char *str) {
	char message[2048];
	gfx_display_t *p_disp = (gfx_display_t *)disp_userdata;
	const char *text = str;
	unsigned text_color = 0xffffffff;
	static float ozone_osk_backdrop[16] = {
		0.00, 0.00, 0.00, 0.15, 0.00, 0.00, 0.00, 0.15, 0.00, 0.00, 0.00, 0.15, 0.00, 0.00, 0.00, 0.15,
	};
	char *tok, *save = NULL;
	unsigned i = 0;
	...
	/* Border */
	/* Top */
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, margin, margin, video_width - (margin * 2),
						  ozone->dimensions.spacer_1px, video_width, video_height, ozone->theme->entries_border, NULL);

	/* Bottom */
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, margin, bottom_end - margin,
						  video_width - (margin * 2), ozone->dimensions.spacer_1px, video_width, video_height,
						  ozone->theme->entries_border, NULL);

	/* Left */
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, margin, margin, ozone->dimensions.spacer_1px,
						  bottom_end - (margin * 2), video_width, video_height, ozone->theme->entries_border, NULL);

	/* Right */
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, video_width - margin, margin,
						  ozone->dimensions.spacer_1px, bottom_end - (margin * 2), video_width, video_height,
						  ozone->theme->entries_border, NULL);

	/* Backdrop */
	/* TODO: Remove the backdrop if blur shader is available */
	gfx_display_draw_quad(
		p_disp, userdata, video_width, video_height, margin + ozone->dimensions.spacer_1px,
		margin + ozone->dimensions.spacer_1px, video_width - (margin * 2) - ozone->dimensions.spacer_2px,
		bottom_end - (margin * 2) - ozone->dimensions.spacer_2px, video_width, video_height, ozone_osk_backdrop, NULL);
	...
	while(tok) {
		...
		gfx_display_draw_text(ozone->fonts.entries_label.font, msg, margin + (padding * 2),
							  margin + padding + ozone->fonts.entries_label.line_height + y_offset, video_width,
							  video_height, text_color, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f, false);

		/* Cursor */
		if(i == list_size - 1) {
			if(ozone->flags & OZONE_FLAG_OSK_CURSOR) {
				unsigned cursor_x = draw_placeholder ? 0
													 : font_driver_get_message_width(ozone->fonts.entries_label.font,
																					 msg, strlen(msg), 1.0f);
				gfx_display_draw_quad(p_disp, userdata, video_width, video_height, margin + (padding * 2) + cursor_x,
									  margin + padding + y_offset + ozone->fonts.entries_label.line_height -
										  ozone->fonts.entries_label.line_ascender + ozone->dimensions.spacer_3px,
									  ozone->dimensions.spacer_1px, ozone->fonts.entries_label.line_ascender,
									  video_width, video_height, ozone->pure_white, NULL);
			}
		} else
	...
	/* Keyboard */
	{
		...
		gfx_display_draw_keyboard(p_disp, userdata, video_width, video_height,
								  ozone->theme->name ? ozone->theme->textures[OZONE_THEME_TEXTURE_CURSOR_STATIC]
													 : ozone->textures[OZONE_TEXTURE_CURSOR_BORDER],
								  ozone->fonts.entries_label.font, input_st->osk_grid, input_st->osk_ptr,
								  ozone->theme->text_rgba);
	}
}

static void ozone_draw_messagebox(ozone_handle_t *ozone, gfx_display_t *p_disp, void *userdata, unsigned video_width,
								  unsigned video_height, const char *message, math_matrix_4x4 *mymat) {
	size_t x, y;
	...
	(ozone->word_wrap)(wrapped_message, sizeof(wrapped_message), message, strlen(message),
					   usable_width / (int)font_data.glyph_width, font_data.wideglyph_width, 0);
	...
	if(ozone->flags & OZONE_FLAG_HAS_ALL_ASSETS || ozone->flags2 & OZONE_FLAG2_IGNORE_MISSING_ASSETS) {
		...
		int slice_y =
			y - line_height - (slice_margin / 4) +
			((slice_new_h >= slice_w) ? (16.0f * scale_factor) : (16.0f * ((float)slice_new_h / (float)slice_w)));

		gfx_display_draw_texture_slice(p_disp, userdata, video_width, video_height, slice_x, slice_y, slice_w, slice_w,
									   (unsigned)slice_new_w, (unsigned)slice_new_h, width, height,
									   ozone->theme_dynamic.message_background, 16, scale_factor,
									   ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_DIALOG_SLICE], mymat);
	}
	...
	for(i = 0; i < list.size; i++) {
		...
		if(msg)
			gfx_display_draw_text(
				font_data.font, msg, x - (longest_width / 2), y + (i * line_height) + font_data.line_ascender, width,
				height,
				COLOR_TEXT_ALPHA(ozone->theme->text_rgba, (uint32_t)(ozone->animations.messagebox_alpha * 255.0f)),
				TEXT_ALIGN_LEFT, 1.0f, false, 1.0f, false);
	}
...
static void ozone_show_fullscreen_thumbnails(ozone_handle_t *ozone) {
	...
	if(menu_update_fullscreen_thumbnail_label(
		   ozone->fullscreen_thumbnail_label, sizeof(ozone->fullscreen_thumbnail_label),
		   (ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU) ? true : false, ozone->title) == 0)
...
static void ozone_draw_fullscreen_thumbnails(ozone_handle_t *ozone, void *userdata, void *disp_userdata,
	...
	if((ozone->animations.fullscreen_thumbnail_alpha > 0.0f) ||
	   (ozone->flags2 & OZONE_FLAG2_WANT_FULLSCREEN_THUMBNAILS)) {
		...
		int view_height = (int)video_height - ozone->dimensions.header_height - ozone->dimensions.footer_height -
						  ozone->dimensions.spacer_1px;
		...
		thumbnail_y = ozone->dimensions.header_height + thumbnail_padding + ozone->dimensions.spacer_1px;
		...
		if(num_thumbnails == 2) {
			...
			right_thumbnail_x = left_thumbnail_x + thumbnail_box_width + frame_width + thumbnail_padding;
		} else {
		...
		/* Sanity check */
		if((thumbnail_box_width < 1) || (thumbnail_box_height < 1))
			goto error;
		...
		if(show_right_thumbnail && right_thumbnail->status == GFX_THUMBNAIL_STATUS_AVAILABLE) {
			gfx_thumbnail_get_draw_dimensions(right_thumbnail, thumbnail_box_width, thumbnail_box_height, 1.0f,
			...
			/* Sanity check */
			if((right_thumbnail_draw_width <= 0.0f) || (right_thumbnail_draw_height <= 0.0f))
				show_right_thumbnail = false;
		...
		if(show_left_thumbnail && left_thumbnail->status == GFX_THUMBNAIL_STATUS_AVAILABLE) {
			gfx_thumbnail_get_draw_dimensions(left_thumbnail, thumbnail_box_width, thumbnail_box_height, 1.0f,
			...
			/* Sanity check */
			if((left_thumbnail_draw_width <= 0.0f) || (left_thumbnail_draw_height <= 0.0f))
				show_left_thumbnail = false;
		...
		/* > Background */
		gfx_display_set_alpha(background_color, background_alpha * ozone->animations.fullscreen_thumbnail_alpha);

		/* > Separators */
		memcpy(separator_color, ozone->theme->header_footer_separator, sizeof(separator_color));
		gfx_display_set_alpha(separator_color, ozone->animations.fullscreen_thumbnail_alpha);

		/* > Thumbnail frame */
		memcpy(frame_color, ozone->theme->sidebar_background, sizeof(frame_color));
		gfx_display_set_alpha(frame_color, ozone->animations.fullscreen_thumbnail_alpha);

		/* Darken background */
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, 0,
							  ozone->dimensions.header_height + ozone->dimensions.spacer_1px, view_width,
							  (unsigned)view_height, video_width, video_height, background_color, NULL);

		/* Draw full-width separators */
		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, 0, ozone->dimensions.header_height,
							  view_width, ozone->dimensions.spacer_1px, video_width, video_height, separator_color,
							  NULL);

		gfx_display_draw_quad(p_disp, userdata, video_width, video_height, 0,
							  video_height - ozone->dimensions.footer_height, view_width, ozone->dimensions.spacer_1px,
							  video_width, video_height, separator_color, NULL);
		...
		if(show_right_thumbnail) {
			...
			gfx_display_draw_quad(
				...
				right_thumbnail_x - frame_width + ((thumbnail_box_width - (int)right_thumbnail_draw_width) >> 1),
				thumbnail_y - frame_width + ((thumbnail_box_height - (int)right_thumbnail_draw_height) >> 1),
				(unsigned)right_thumbnail_draw_width + (frame_width << 1),
				(unsigned)right_thumbnail_draw_height + (frame_width << 1), video_width, video_height, frame_color,
				NULL);

			/* Thumbnail */
			gfx_thumbnail_draw(userdata, video_width, video_height, right_thumbnail, right_thumbnail_x, thumbnail_y,
							   (unsigned)thumbnail_box_width, (unsigned)thumbnail_box_height,
							   GFX_THUMBNAIL_ALIGN_CENTRE, ozone->animations.fullscreen_thumbnail_alpha, 1.0f, NULL);
		}
		...
		if(show_left_thumbnail) {
			...
			gfx_display_draw_quad(
				p_disp, userdata, video_width, video_height,
				left_thumbnail_x - frame_width + ((thumbnail_box_width - (int)left_thumbnail_draw_width) >> 1),
				thumbnail_y - frame_width + ((thumbnail_box_height - (int)left_thumbnail_draw_height) >> 1),
				(unsigned)left_thumbnail_draw_width + (frame_width << 1),
				(unsigned)left_thumbnail_draw_height + (frame_width << 1), video_width, video_height, frame_color,
				NULL);

			/* Thumbnail */
			gfx_thumbnail_draw(userdata, video_width, video_height, left_thumbnail, left_thumbnail_x, thumbnail_y,
							   (unsigned)thumbnail_box_width, (unsigned)thumbnail_box_height,
							   GFX_THUMBNAIL_ALIGN_CENTRE, ozone->animations.fullscreen_thumbnail_alpha, 1.0f, NULL);
		}
		...
		if(!show_right_thumbnail && !show_left_thumbnail) {
			ozone_draw_no_thumbnail_available(ozone, p_disp, userdata, video_width, video_height, 0, thumbnail_y,
											  view_width, view_height, true, NULL);
		}
	}
	return;
...
static void ozone_set_thumbnail_content(void *data, const char *s) {
	...
	if(ozone->flags & OZONE_FLAG_IS_PLAYLIST) {
		...
		if(string_is_empty(s)) {
			...
			/* Get playlist index corresponding
			 * to the selected entry */
			if(list && (selection < list_size) && (list->list[selection].type == FILE_TYPE_RPL_ENTRY)) {
				selection = list->list[selection].entry_idx;
				pl = playlist_get_cached();
			}

			gfx_thumbnail_set_content_playlist(menu_st->thumbnail_path_data, pl, selection);
 ...
 * displayed on screen */
static INLINE bool ozone_category_onscreen(ozone_handle_t *ozone, size_t idx) {
	return (idx >= ozone->first_onscreen_category) && (idx <= ozone->last_onscreen_category);
}
...
static size_t ozone_get_onscreen_category_selection(ozone_handle_t *ozone) {
 ...
 *   already on screen */
static void ozone_auto_select_onscreen_entry(ozone_handle_t *ozone,
...
static INLINE bool ozone_metadata_override_available(ozone_handle_t *ozone, unsigned menu_left_thumbnails) {
	/* Ugly construct...
	...
	return ((ozone->flags & OZONE_FLAG_IS_PLAYLIST) || (ozone->flags & OZONE_FLAG_IS_EXPLORE_LIST)) &&
		   (ozone->show_thumbnail_bar) && (menu_left_thumbnails) &&
		   (!(ozone->flags2 & OZONE_FLAG2_SELECTION_CORE_IS_VIEWER)) &&
...
static INLINE bool ozone_fullscreen_thumbnails_available(ozone_handle_t *ozone, struct menu_state *menu_st) {
	bool ret = (!(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR)) && (ozone->show_thumbnail_bar) &&
			   (gfx_thumbnail_is_enabled(menu_st->thumbnail_path_data, GFX_THUMBNAIL_RIGHT) ||
				gfx_thumbnail_is_enabled(menu_st->thumbnail_path_data, GFX_THUMBNAIL_LEFT));
...
static bool ozone_clear_available(ozone_handle_t *ozone, size_t current_selection) {
	...
	if(last_entry.setting_type == ST_BIND) {
		return true;
	} else if(last_entry.type >= MENU_SETTINGS_INPUT_DESC_BEGIN && last_entry.type <= MENU_SETTINGS_INPUT_DESC_END) {
		return true;
...
static bool ozone_manage_available(ozone_handle_t *ozone, size_t current_selection) {
	...
	if((ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR) && (ozone->flags & OZONE_FLAG_IS_PLAYLIST) &&
	   ozone->categories_selection_ptr > ozone->system_tab_end)
		return true;
 ...
 * once it has started
 */
static void ozone_start_cursor_wiggle(ozone_handle_t *ozone, enum menu_action direction) {
	/* Don't start another wiggle animation on top of another */
	if(!ozone || (ozone->flags2 & OZONE_FLAG2_CURSOR_WIGGLING))
		return;

	/* Don't allow wiggling in invalid directions */
	if(!(direction == MENU_ACTION_UP || direction == MENU_ACTION_DOWN || direction == MENU_ACTION_LEFT ||
...
static enum menu_action ozone_parse_menu_entry_action(ozone_handle_t *ozone, bool menu_navigation_wraparound_enable,
													  bool ozone_collapse_sidebar, enum menu_action action) {
	uintptr_t tag;
	int new_selection;
	size_t selection;
	...
	if((action != MENU_ACTION_NOOP) && (ozone->thumbnails.stream_delay != OZONE_THUMBNAIL_STREAM_DELAY) &&
	   !(ozone->flags2 & OZONE_FLAG2_SHOW_FULLSCREEN_THUMBNAILS)) {
		ozone->thumbnails.stream_delay = OZONE_THUMBNAIL_STREAM_DELAY;
		gfx_thumbnail_set_stream_delay(ozone->thumbnails.stream_delay);
	}
	...
	switch(action) {
		case MENU_ACTION_START:
			...
			if(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR) {
				...
				fill_pathname_join(playlist_path, settings->paths.directory_playlist,
								   ozone->horizontal_list.list[new_selection].path, sizeof(playlist_path));

				generic_action_ok_displaylist_push(
					playlist_path, NULL, msg_hash_to_str(MENU_ENUM_LABEL_PLAYLIST_MANAGER_SETTINGS),
					MENU_SETTING_ACTION, ozone->tab_selection[ozone->categories_selection_ptr], 0,
					ACTION_OK_DL_PLAYLIST_MANAGER_SETTINGS);

				ozone->flags &= ~(OZONE_FLAG_CURSOR_IN_SIDEBAR | OZONE_FLAG_WANT_THUMBNAIL_BAR);
		...
		case MENU_ACTION_SCAN:
			if(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR) {
				...
				new_selection = random_range((unsigned)(ozone->system_tab_end + 1),
											 (unsigned)(ozone->system_tab_end + horizontal_list_size));
				...
				struct menu_state *menu_st = menu_state_get_ptr();
				size_t selection_total =
					menu_st->entries.list ? MENU_LIST_GET_SELECTION(menu_st->entries.list, 0)->size : 0;
				size_t selection = menu_st->selection_ptr;
				...
				if(new_selection != selection)
					audio_driver_mixer_play_scroll_sound(true);
#endif
			} else if((ozone->flags & OZONE_FLAG_IS_PLAYLIST) || (ozone->flags & OZONE_FLAG_IS_EXPLORE_LIST)) {
				size_t new_selection =
					menu_playlist_random_selection(selection, ozone->flags & OZONE_FLAG_IS_EXPLORE_LIST);
			...
			ozone->flags &= ~(OZONE_FLAG_SKIP_THUMBNAIL_RESET | OZONE_FLAG_CURSOR_MODE);
		...
		case MENU_ACTION_DOWN:
			if(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR) {
				...
				if(!menu_navigation_wraparound_enable && selection == ozone->system_tab_end + horizontal_list_size)
			...
			if((ozone->flags2 & OZONE_FLAG2_SHOW_FULLSCREEN_THUMBNAILS) && (ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU))
				return MENU_ACTION_NOOP;

			/* If pointer is active and current selection
			 * is off screen, auto select *centre* item */
			if((ozone->flags & OZONE_FLAG_CURSOR_MODE) && (!OZONE_ENTRY_ONSCREEN(ozone, selection)))
		...
		case MENU_ACTION_LEFT:
			...
			if(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR) {
				...
				break;
			} else if((ozone->depth == 1) && (ozone->flags2 & OZONE_FLAG2_SHOW_FULLSCREEN_THUMBNAILS) &&
		...
		case MENU_ACTION_OK:
			...
			if((ozone->flags & OZONE_FLAG_LIBRETRO_RUNNING) && (ozone->flags & OZONE_FLAG_IS_FILE_LIST) &&
			   (ozone->flags & OZONE_FLAG_FULLSCREEN_THUMBNAILS_AVAILABLE) && (ozone->show_thumbnail_bar)) {
			...
			if((ozone->flags2 & OZONE_FLAG2_SHOW_FULLSCREEN_THUMBNAILS) ||
			   (ozone->flags2 & OZONE_FLAG2_WANT_FULLSCREEN_THUMBNAILS)) {
				ozone->flags2 &= ~OZONE_FLAG2_WANT_FULLSCREEN_THUMBNAILS;
				ozone_hide_fullscreen_thumbnails(ozone, true);
				if((!(ozone->flags & OZONE_FLAG_IS_STATE_SLOT)) && (!(ozone->flags & OZONE_FLAG_IS_PLAYLIST)) &&
			 ...
			 * location, otherwise sidebar gets stuck in wrong position */
			{
				...
				if(list->size) {
					if(string_is_equal(list->list[list->size - 1].label,
		...
		case MENU_ACTION_SCROLL_UP:
			...
			if(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR) {
				...
				if(menu_st->scroll.mode == MENU_SCROLL_PAGE)
					...
					while(l && ozone->sidebar_index_list[l - 1] >= tab_selection)
						l--;
				...
				if(tab_selection < (size_t)(ozone->system_tab_end + 1))
					new_selection = 0;
				else if(tab_selection > ozone->system_tab_end - new_selection || new_selection < 0)
		...
		case MENU_ACTION_INFO:
			 ...
			 * override */
			if(ozone_metadata_override_available(ozone, settings->uints.menu_left_thumbnails)) {
			 ...
			 *   toggle metadata... */
			else if((ozone->flags & OZONE_FLAG_IS_PLAYLIST) && (ozone->show_thumbnail_bar))
				new_action = MENU_ACTION_NOOP;
...
static int ozone_menu_entry_action(void *userdata, menu_entry_t *entry, size_t i, enum menu_action action) {
	...
	enum menu_action new_action = ozone_parse_menu_entry_action(
		ozone, settings->bools.menu_navigation_wraparound_enable, settings->bools.ozone_collapse_sidebar, action);
...
static void ozone_menu_animation_update_time(float *ticker_pixel_increment, unsigned video_width,
	...
	*(ticker_pixel_increment) *=
		gfx_display_get_dpi_scale(p_disp, settings, video_width, video_height, false, false) * 0.5f;
}
...
static void *ozone_init(void **userdata, bool video_is_threaded) {
	...
	*userdata = ozone;
	...
	ozone->last_scale_factor = gfx_display_get_dpi_scale(p_disp, settings, width, height, false, false);
   ...
   if (      settings->bools.menu_content_show_add
	...
	if(settings->bools.menu_use_preferred_system_color_theme) {
		...
		if(R_SUCCEEDED(setsysInitialize())) {
			...
			configuration_set_uint(settings, settings->uints.menu_ozone_color_theme, color_theme);
			configuration_set_bool(settings, settings->bools.menu_preferred_system_color_theme_set, true);
			setsysExit();
		} else
#endif
	...
	/* Assets path */
	fill_pathname_join_special(ozone->assets_path, directory_assets, "ozone", sizeof(ozone->assets_path));

	/* PNG path */
	fill_pathname_join_special(ozone->png_path, ozone->assets_path, "png", sizeof(ozone->png_path));

	/* Sidebar path */
	fill_pathname_join_special(ozone->tab_path, ozone->png_path, "sidebar", sizeof(ozone->tab_path));

	/* Icons path */
	fill_pathname_application_special(ozone->icons_path, sizeof(ozone->icons_path),
									  APPLICATION_SPECIAL_DIRECTORY_ASSETS_OZONE_ICONS);
	fill_pathname_join_special(ozone->icons_path_default, ozone->icons_path, "default",
...
static void ozone_update_thumbnail_image(void *data) {
	...
	if(ozone->flags2 & OZONE_FLAG2_WANT_FULLSCREEN_THUMBNAILS)
		menu_update_fullscreen_thumbnail_label(
			ozone->fullscreen_thumbnail_label, sizeof(ozone->fullscreen_thumbnail_label),
			(ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU) ? true : false, ozone->title);
}
...
static void ozone_refresh_thumbnail_image(void *data, unsigned i) {
	...
	if((gfx_thumbnail_is_enabled(menu_st->thumbnail_path_data, GFX_THUMBNAIL_RIGHT) ||
		gfx_thumbnail_is_enabled(menu_st->thumbnail_path_data, GFX_THUMBNAIL_LEFT)) &&
	   (ozone->flags & OZONE_FLAG_WANT_THUMBNAIL_BAR) &&
	   ((ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU) || (ozone->flags & OZONE_FLAG_IS_PLAYLIST) ||
		(ozone->flags & OZONE_FLAG_IS_EXPLORE_LIST)))
		ozone_update_thumbnail_image(ozone);
}

static bool ozone_init_font(font_data_impl_t *font_data, bool is_threaded, char *font_path, float font_size) {
	int glyph_width = 0;
	gfx_display_t *p_disp = disp_get_ptr();
...
static void ozone_cache_footer_label(ozone_handle_t *ozone, ozone_footer_label_t *label, enum msg_hash_enums enum_idx) {
...
static void ozone_cache_footer_labels(ozone_handle_t *ozone) {
	...
	ozone_cache_footer_label(ozone, &ozone->footer_labels.ok, MENU_ENUM_LABEL_VALUE_BASIC_MENU_CONTROLS_OK);

	ozone_cache_footer_label(ozone, &ozone->footer_labels.back, MENU_ENUM_LABEL_VALUE_BASIC_MENU_CONTROLS_BACK);

	ozone_cache_footer_label(ozone, &ozone->footer_labels.search, MENU_ENUM_LABEL_VALUE_SEARCH);

	ozone_cache_footer_label(ozone, &ozone->footer_labels.reset_to_default,
							 MENU_ENUM_LABEL_VALUE_RESET_TO_DEFAULT_CONFIG);

	ozone_cache_footer_label(ozone, &ozone->footer_labels.random_select, MENU_ENUM_LABEL_VALUE_RANDOM_SELECT);

	ozone_cache_footer_label(ozone, &ozone->footer_labels.cycle_thumbnails, MENU_ENUM_LABEL_VALUE_CYCLE_THUMBNAILS);

	ozone_cache_footer_label(ozone, &ozone->footer_labels.fullscreen_thumbnails, MSG_TOGGLE_FULLSCREEN_THUMBNAILS);

	ozone_cache_footer_label(ozone, &ozone->footer_labels.metadata_override, MSG_TOGGLE_CONTENT_METADATA);

	ozone_cache_footer_label(ozone, &ozone->footer_labels.help, MENU_ENUM_LABEL_VALUE_HELP);

	ozone_cache_footer_label(ozone, &ozone->footer_labels.clear_setting, MENU_ENUM_LABEL_VALUE_CLEAR_SETTING);

	ozone_cache_footer_label(ozone, &ozone->footer_labels.scan, MENU_ENUM_LABEL_VALUE_SCAN_ENTRY);

	ozone_cache_footer_label(ozone, &ozone->footer_labels.manage, MENU_ENUM_LABEL_VALUE_MANAGE);
...
static void ozone_set_layout(ozone_handle_t *ozone, const char *path_directory_assets, bool ozone_collapse_sidebar,
							 bool is_threaded) {
	...
	ozone->dimensions.thumbnail_bar_width =
		...
		(ozone->dimensions.sidebar_width_normal - ozone->dimensions.sidebar_entry_icon_size +
		 ozone->dimensions.sidebar_entry_icon_padding);
	...
	font_inited = ozone_init_font(&ozone->fonts.title, is_threaded, font_path, FONT_SIZE_TITLE * scale_factor);
	...
	/* Sidebar */
	font_inited = ozone_init_font(&ozone->fonts.sidebar, is_threaded, font_path, FONT_SIZE_SIDEBAR * scale_factor);
	if(!(((ozone->flags & OZONE_FLAG_HAS_ALL_ASSETS) > 0) && font_inited))
		ozone->flags &= ~OZONE_FLAG_HAS_ALL_ASSETS;

	/* Entries */
	font_inited =
		ozone_init_font(&ozone->fonts.entries_label, is_threaded, font_path, FONT_SIZE_ENTRIES_LABEL * scale_factor);
	if(!(((ozone->flags & OZONE_FLAG_HAS_ALL_ASSETS) > 0) && font_inited))
		ozone->flags &= ~OZONE_FLAG_HAS_ALL_ASSETS;

	/* Sublabels */
	font_inited = ozone_init_font(&ozone->fonts.entries_sublabel, is_threaded, font_path,
								  FONT_SIZE_ENTRIES_SUBLABEL * scale_factor);
	if(!(((ozone->flags & OZONE_FLAG_HAS_ALL_ASSETS) > 0) && font_inited))
		ozone->flags &= ~OZONE_FLAG_HAS_ALL_ASSETS;

	/* Time */
	font_inited = ozone_init_font(&ozone->fonts.time, is_threaded, font_path, FONT_SIZE_TIME * scale_factor);
	if(!(((ozone->flags & OZONE_FLAG_HAS_ALL_ASSETS) > 0) && font_inited))
		ozone->flags &= ~OZONE_FLAG_HAS_ALL_ASSETS;

	/* Footer */
	font_inited = ozone_init_font(&ozone->fonts.footer, is_threaded, font_path, FONT_SIZE_FOOTER * scale_factor);
	if(!(((ozone->flags & OZONE_FLAG_HAS_ALL_ASSETS) > 0) && font_inited))
		ozone->flags &= ~OZONE_FLAG_HAS_ALL_ASSETS;
...
static void ozone_context_reset(void *data, bool is_threaded) {
	...
	static const char *OZONE_TEXTURES_FILES[OZONE_TEXTURE_LAST] = {"retroarch.png", "cursor_border.png"};
	unsigned i;
	ozone_handle_t *ozone = (ozone_handle_t *)data;
	...
	if(ozone) {
		...
		ozone_set_layout(ozone, settings->paths.directory_assets, settings->bools.ozone_collapse_sidebar, is_threaded);
		...
		for(i = 0; i < OZONE_TEXTURE_LAST; i++) {
			...
			if(!gfx_display_reset_textures_list(filename, ozone->png_path, &ozone->textures[i],
												TEXTURE_FILTER_MIPMAP_LINEAR, NULL, NULL))
				ozone->flags &= ~OZONE_FLAG_HAS_ALL_ASSETS;
		}
		...
		for(i = 0; i < OZONE_TAB_TEXTURE_LAST; i++) {
			switch(i) {
				...
				case OZONE_TAB_TEXTURE_EXPLORE:
					if(!gfx_display_reset_textures_list(OZONE_TAB_TEXTURES_FILES[i], ozone->icons_path,
														&ozone->tab_textures[i], TEXTURE_FILTER_MIPMAP_LINEAR, NULL,
														NULL))
						ozone->flags &= ~OZONE_FLAG_HAS_ALL_ASSETS;
					break;
				default:
					if(!gfx_display_reset_textures_list(OZONE_TAB_TEXTURES_FILES[i], ozone->tab_path,
														&ozone->tab_textures[i], TEXTURE_FILTER_MIPMAP_LINEAR, NULL,
														NULL))
						ozone->flags &= ~OZONE_FLAG_HAS_ALL_ASSETS;
					break;
		...
		for(i = 0; i < OZONE_ENTRIES_ICONS_TEXTURE_LAST; i++) {
			if(!gfx_display_reset_textures_list(ozone_entries_icon_texture_path(i), ozone->icons_path,
												&ozone->icons_textures[i], TEXTURE_FILTER_MIPMAP_LINEAR, NULL, NULL))
				ozone->flags &= ~OZONE_FLAG_HAS_ALL_ASSETS;
		}
		...
		/* State reset */
		ozone->flags &= ~(OZONE_FLAG_DRAW_OLD_LIST | OZONE_FLAG_FADE_DIRECTION | OZONE_FLAG_CURSOR_IN_SIDEBAR |
						  OZONE_FLAG_CURSOR_IN_SIDEBAR_OLD | OZONE_FLAG_MSGBOX_STATE | OZONE_FLAG_MSGBOX_STATE_OLD);
...
static void *ozone_list_get_entry(void *data, enum menu_list_type type, unsigned i) {
	ozone_handle_t *ozone = (ozone_handle_t *)data;
...
static int ozone_list_push(void *data, void *userdata, menu_displaylist_info_t *info, unsigned type) {
	...
	switch(type) {
		case DISPLAYLIST_LOAD_CONTENT_LIST: {
			...
			menu_entries_append(info->list, msg_hash_to_str(MENU_ENUM_LABEL_VALUE_FAVORITES),
								msg_hash_to_str(MENU_ENUM_LABEL_FAVORITES), MENU_ENUM_LABEL_FAVORITES,
								MENU_SETTING_ACTION_FAVORITES_DIR, 0, 0, NULL);

			if(menu_content_show_playlists)
				menu_entries_append(info->list, msg_hash_to_str(MENU_ENUM_LABEL_VALUE_PLAYLISTS_TAB),
									msg_hash_to_str(MENU_ENUM_LABEL_PLAYLISTS_TAB), MENU_ENUM_LABEL_PLAYLISTS_TAB,
									MENU_SETTING_ACTION, 0, 0, NULL);

			if(list && list->info_count > 0)
				menu_entries_append(info->list, msg_hash_to_str(MENU_ENUM_LABEL_VALUE_DOWNLOADED_FILE_DETECT_CORE_LIST),
									msg_hash_to_str(MENU_ENUM_LABEL_DOWNLOADED_FILE_DETECT_CORE_LIST),
									MENU_ENUM_LABEL_DOWNLOADED_FILE_DETECT_CORE_LIST, MENU_SETTING_ACTION, 0, 0, NULL);

			if(frontend_driver_parse_drive_list(info->list, true) != 0)
				menu_entries_append(info->list, "/", msg_hash_to_str(MENU_ENUM_LABEL_FILE_DETECT_CORE_LIST_PUSH_DIR),
									MENU_ENUM_LABEL_FILE_DETECT_CORE_LIST_PUSH_DIR, MENU_SETTING_ACTION, 0, 0, NULL);

			if(!kiosk_mode_enable)
				menu_entries_append(info->list, msg_hash_to_str(MENU_ENUM_LABEL_VALUE_MENU_FILE_BROWSER_SETTINGS),
									msg_hash_to_str(MENU_ENUM_LABEL_MENU_FILE_BROWSER_SETTINGS),
									MENU_ENUM_LABEL_MENU_FILE_BROWSER_SETTINGS, MENU_SETTING_ACTION, 0, 0, NULL);
		...
		case DISPLAYLIST_MAIN_MENU: {
			...
			if(flags & RUNLOOP_FLAG_CORE_RUNNING) {
				if(!retroarch_ctl(RARCH_CTL_IS_DUMMY_CORE, NULL)) {
					MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_CONTENT_SETTINGS, PARSE_ACTION,
														 false);
				}
			} else {
				rarch_system_info_t *sys_info = &runloop_state_get_ptr()->system;
				if(sys_info && sys_info->load_no_content) {
					MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_START_CORE, PARSE_ACTION, false);
				}
...
#endif
				{
					if(settings->bools.menu_show_load_core) {
						MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_CORE_LIST, PARSE_ACTION,
															 false);
					}
				}
			}
			...
			if(settings->bools.menu_show_load_content) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_LOAD_CONTENT_LIST, PARSE_ACTION,
													 false);

				if(menu_displaylist_has_subsystems()) {
					MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_SUBSYSTEM_SETTINGS, PARSE_ACTION,
														 false);
				}
			}

			if(settings->bools.menu_show_load_disc) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_LOAD_DISC, PARSE_ACTION, false);
			}

			if(settings->bools.menu_show_dump_disc) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_DUMP_DISC, PARSE_ACTION, false);
			}

#ifdef HAVE_LAKKA
			if(settings->bools.menu_show_eject_disc) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_EJECT_DISC, PARSE_ACTION, false);
			}
#endif

			MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_ADD_CONTENT_LIST, PARSE_ACTION, false);
#ifdef HAVE_QT
			if(settings->bools.desktop_menu_enable) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_SHOW_WIMP, PARSE_ACTION, false);
			}
#endif
#if defined(HAVE_NETWORKING)
#if defined(HAVE_ONLINE_UPDATER)
			if(settings->bools.menu_show_online_updater && !settings->bools.kiosk_mode_enable) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_ONLINE_UPDATER, PARSE_ACTION, false);
			}
#endif
#endif
#ifdef HAVE_MIST
			if(settings->bools.menu_show_core_manager_steam && !settings->bools.kiosk_mode_enable) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_CORE_MANAGER_STEAM_LIST, PARSE_ACTION,
													 false);
			}
#endif
			if(!settings->bools.menu_content_show_settings &&
			   !string_is_empty(settings->paths.menu_content_show_settings_password)) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_XMB_MAIN_MENU_ENABLE_SETTINGS,
													 PARSE_ACTION, false);
			}

			if(settings->bools.kiosk_mode_enable && !string_is_empty(settings->paths.kiosk_mode_password)) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_MENU_DISABLE_KIOSK_MODE, PARSE_ACTION,
													 false);
			}

			if(settings->bools.menu_show_information) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_INFORMATION_LIST, PARSE_ACTION, false);
			}

#if defined(HAVE_LIBNX)
			MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_SWITCH_CPU_PROFILE, PARSE_ACTION, false);
#endif

			if(settings->bools.menu_show_configurations && !settings->bools.kiosk_mode_enable) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_CONFIGURATIONS_LIST, PARSE_ACTION,
													 false);
			}

#if !defined(IOS)
			if(settings->bools.menu_show_restart_retroarch) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_RESTART_RETROARCH, PARSE_ACTION,
													 false);
			}

			if(settings->bools.menu_show_quit_retroarch) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_QUIT_RETROARCH, PARSE_ACTION, false);
			}
#endif

			if(true) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_REBOOT, PARSE_ACTION, false);
			}

			if(true) {
				MENU_DISPLAYLIST_PARSE_SETTINGS_ENUM(info->list, MENU_ENUM_LABEL_SHUTDOWN, PARSE_ACTION, false);
			}
...
static void ozone_list_free(file_list_t *list, size_t a, size_t b) { ozone_list_clear(list); }

static void ozone_render(void *data, unsigned width, unsigned height, bool is_idle) {
	size_t i;
	 ...
	 * factor have changed */
	scale_factor = gfx_display_get_dpi_scale(p_disp, settings, width, height, false, false);
	thumbnail_scale_factor = settings->floats.ozone_thumbnail_scale_factor;

	if((scale_factor != ozone->last_scale_factor) || (thumbnail_scale_factor != ozone->last_thumbnail_scale_factor) ||
	   (width != ozone->last_width) || (height != ozone->last_height)) {
		...
		ozone_set_layout(ozone, settings->paths.directory_assets, ozone_collapse_sidebar, video_driver_is_threaded());
		video_driver_monitor_reset();
	}

	if(ozone->flags & OZONE_FLAG_NEED_COMPUTE) {
		ozone_compute_entries_position(ozone, settings->bools.savestate_thumbnail_enable,
	...
	if(ozone->flags & OZONE_FLAG_SHOW_SCREENSAVER) {
		menu_screensaver_iterate(ozone->screensaver, p_disp, p_anim,
								 (enum menu_screensaver_effect)settings->uints.menu_screensaver_animation,
								 settings->floats.menu_screensaver_animation_speed, ozone->theme->screensaver_tint,
								 width, height, settings->paths.directory_assets);
	...
	if(ozone->pointer.type != MENU_POINTER_DISABLED) {
		...
		if(ozone->pointer.type == MENU_POINTER_MOUSE) {
			...
			if((cursor_x_delta > ozone->pointer_active_delta) || (cursor_x_delta < -ozone->pointer_active_delta) ||
			   (cursor_y_delta > ozone->pointer_active_delta) || (cursor_y_delta < -ozone->pointer_active_delta))
				ozone->flags |= OZONE_FLAG_CURSOR_MODE;
		}
		/* On touchscreens, just check for any movement */
		else {
			if((ozone->pointer.x != ozone->cursor_x_old) || (ozone->pointer.y != ozone->cursor_y_old))
				ozone->flags |= OZONE_FLAG_CURSOR_MODE;
		}
	}
	...
	pointer_enabled = (ozone->flags & OZONE_FLAG_CURSOR_MODE) &&
					  (!(ozone->flags2 & OZONE_FLAG2_SHOW_FULLSCREEN_THUMBNAILS)) &&
					  !menu_input_dialog_get_display_kb() && (!(ozone->flags & OZONE_FLAG_SHOULD_DRAW_MSGBOX));
	...
	if(pointer_enabled) {
		...
		int entry_padding = (ozone->depth == 1) ? ozone->dimensions.entry_padding_horizontal_half
												: ozone->dimensions.entry_padding_horizontal_full;
		float entry_x = ozone->dimensions_sidebar_width + ozone->sidebar_offset + entry_padding;
		float entry_width = width - ozone->dimensions_sidebar_width - ozone->sidebar_offset - entry_padding * 2 -
		...
		float category_height =
			ozone->dimensions.sidebar_entry_height + ozone->dimensions.sidebar_entry_padding_vertical;
		...
		if(ozone->flags2 & OZONE_FLAG2_POINTER_IN_SIDEBAR)
			...
			ozone->flags2 &= ~OZONE_FLAG2_LAST_POINTER_IN_SIDEBAR;
		if((ozone->pointer.type == MENU_POINTER_MOUSE) || (ozone->pointer.flags & MENU_INP_PTR_FLG_PRESSED)) {
		...
		if((pointer_in_sidebar) != (last_pointer_in_sidebar)) {
			menu_input->pointer.y_accel = 0.0f;
		...
		if(ozone->pointer.type == MENU_POINTER_MOUSE) {
			if((pointer_in_sidebar) && (!(last_pointer_in_sidebar)) && (!(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR)))
				ozone_go_to_sidebar(ozone, ozone_collapse_sidebar, animation_tag);
			else if((!pointer_in_sidebar) && (last_pointer_in_sidebar) && (ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR))
				if(!(ozone->flags & OZONE_FLAG_EMPTY_PLAYLIST))
			...
			if((pointer_in_sidebar) && (!(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR)))
				ozone_go_to_sidebar(ozone, ozone_collapse_sidebar, animation_tag);
		}
		 ...
		 * > Entries */
		if(!(ozone->flags2 & OZONE_FLAG2_POINTER_IN_SIDEBAR)) {
			float entry_bottom_boundary = height - ozone->dimensions.header_height - ozone->dimensions.spacer_1px -
										  ozone->dimensions.footer_height -
		 ...
		 * cursor is currently *in* the sidebar */
			...
			float sidebar_bottom_boundary = height - (ozone->dimensions.header_height + ozone->dimensions.spacer_1px) -
											ozone->dimensions.footer_height -
											ozone->dimensions.sidebar_padding_vertical;
		...
		for(i = 0; i < entries_end; i++) {
			...
			entry_y = ozone->dimensions.header_height + ozone->dimensions.spacer_1px +
					  ozone->dimensions.entry_padding_vertical + ozone->animations.scroll_y + node->position_y;
			...
			if((!(ozone->flags2 & OZONE_FLAG2_POINTER_IN_SIDEBAR)) && first_entry_found && !last_entry_found) {
				/* Check whether pointer is within the bounds
				 * of the current entry */
				if((ozone->pointer.x > entry_x) && (ozone->pointer.x < entry_x + entry_width) &&
				   (ozone->pointer.y > entry_y) && (ozone->pointer.y < entry_y + node->height)) {
					...
					if(ozone->pointer.type == MENU_POINTER_MOUSE) {
						...
						if((!(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR)) && (i != ozone->selection) &&
					...
					if((ozone->pointer.flags & MENU_INP_PTR_FLG_PRESSED) &&
					   ...
					   (ozone->pointer.press_duration >= MENU_INPUT_PRESS_TIME_SHORT) && (i != ozone->selection)) {
						menu_st->selection_ptr = i;
						...
						/* If this is a playlist, must update thumbnails */
						else if((ozone->flags & OZONE_FLAG_IS_PLAYLIST) && (ozone->depth == 1 || ozone->depth == 3)) {
							ozone_set_thumbnail_content(ozone, "");
							ozone_update_thumbnail_image(ozone);
						}
					}
		...
		for(i = 0; i < ozone->system_tab_end + horizontal_list_size + 1; i++) {
			...
			/* Track pointer input, if required */
			if((ozone->flags2 & OZONE_FLAG2_POINTER_IN_SIDEBAR) && (ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR) &&
			   first_category_found && !last_category_found) {
				/* If pointer is within the bounds of the
				 * current category, cache category index
				 * (for use in next 'pointer up' event) */
				if((ozone->pointer.y > category_y) && (ozone->pointer.y < category_y + category_height))
	...
	if(ozone->show_thumbnail_bar && (ozone->thumbnails.pending != OZONE_PENDING_THUMBNAIL_NONE)) {
		...
		switch(ozone->thumbnails.pending) {
			case OZONE_PENDING_THUMBNAIL_BOTH:
				gfx_thumbnail_request_streams(menu_st->thumbnail_path_data, p_anim, playlist, selection,
											  &ozone->thumbnails.right, &ozone->thumbnails.left,
											  gfx_thumbnail_upscale_threshold, network_on_demand_thumbnails);
			...
			case OZONE_PENDING_THUMBNAIL_RIGHT:
				gfx_thumbnail_request_stream(menu_st->thumbnail_path_data, p_anim, GFX_THUMBNAIL_RIGHT, playlist,
											 selection, &ozone->thumbnails.right, gfx_thumbnail_upscale_threshold,
			...
			case OZONE_PENDING_THUMBNAIL_LEFT:
				gfx_thumbnail_request_stream(menu_st->thumbnail_path_data, p_anim, GFX_THUMBNAIL_LEFT, playlist,
											 selection, &ozone->thumbnails.left, gfx_thumbnail_upscale_threshold,
											 network_on_demand_thumbnails);
...
static void ozone_draw_header(ozone_handle_t *ozone, gfx_display_t *p_disp, gfx_animation_t *p_anim,
							  settings_t *settings, void *userdata, unsigned video_width, unsigned video_height,
							  bool battery_level_enable, bool timedate_enable, math_matrix_4x4 *mymat) {
	char title[NAME_MAX_LENGTH];
	static const char *const ticker_spacer = OZONE_TICKER_SPACER;
	gfx_animation_ctx_ticker_t ticker;
	gfx_animation_ctx_ticker_smooth_t ticker_smooth;
	...
	/* Separator */
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, separator_margin,
						  ozone->dimensions.header_height, video_width - separator_margin * 2,
						  ozone->dimensions.spacer_1px, video_width, video_height,
						  ozone->theme->header_footer_separator, NULL);
	...
	if(dispctx) {
		if(dispctx->blend_begin)
			dispctx->blend_begin(userdata);
		if(dispctx->draw) {
			ozone_draw_icon(p_disp, userdata, video_width, video_height, logo_icon_size, logo_icon_size,
							ozone->textures[OZONE_TEXTURE_RETROARCH], 47 * scale_factor,
							(ozone->dimensions.header_height - logo_icon_size) / 2, video_width, video_height, 0.0f,
							1.0f, col, mymat);
		}
		if(dispctx->blend_end)
			dispctx->blend_end(userdata);
	...
	if(battery_level_enable) {
		...
		if(powerstate.battery_enabled) {
			...
			gfx_display_draw_text(ozone->fonts.time.font, msg, video_width - 55 * scale_factor,
								  ozone->dimensions.header_height / 2 + ozone->fonts.time.line_centre_offset,
								  video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_RIGHT, 1.0f, false,
								  1.0f, false);
			...
			if(dispctx) {
				...
				if(dispctx->draw)
					ozone_draw_icon(
						p_disp, userdata, video_width, video_height, status_icon_size, status_icon_size,
						ozone->icons_textures[powerstate.charging		  ? OZONE_ENTRIES_ICONS_TEXTURE_BATTERY_CHARGING
											  ...
											  : (powerstate.percent > 20) ? OZONE_ENTRIES_ICONS_TEXTURE_BATTERY_40
																		  : OZONE_ENTRIES_ICONS_TEXTURE_BATTERY_20],
						video_width - (55 + 32) * scale_factor, 0, video_width, video_height, 0.0f, 1.0f, col, mymat);
				if(dispctx->blend_end)
					dispctx->blend_end(userdata);
			}
		}
	...
	if(timedate_enable) {
		...
		gfx_display_draw_text(ozone->fonts.time.font, timedate, video_width - (64 * scale_factor) - timedate_offset,
							  ozone->dimensions.header_height / 2 + ozone->fonts.time.line_centre_offset, video_width,
							  video_height, ozone->theme->text_rgba, TEXT_ALIGN_RIGHT, 1.0f, false, 1.0f, false);

		if(dispctx) {
			if(dispctx->blend_begin)
				dispctx->blend_begin(userdata);
			if(dispctx->draw)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, status_icon_size, status_icon_size,
								ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_CLOCK],
								video_width - (64 + 28) * scale_factor - timedate_offset, 0, video_width, video_height,
								0.0f, 1.0f, col, mymat);
			if(dispctx->blend_end)
				dispctx->blend_end(userdata);
		}
	...
	if(use_smooth_ticker) {
		...
		ticker_smooth.src_str =
			(ozone->flags2 & OZONE_FLAG2_WANT_FULLSCREEN_THUMBNAILS) ? ozone->fullscreen_thumbnail_label : ozone->title;
	...
	gfx_display_draw_text(ozone->fonts.title.font, title, ticker_x_offset + 128 * scale_factor,
						  ozone->dimensions.header_height / 2 + ozone->fonts.title.line_centre_offset, video_width,
						  video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f, false);
}

static void ozone_draw_footer(ozone_handle_t *ozone, struct menu_state *menu_st, gfx_display_t *p_disp,
							  gfx_animation_t *p_anim, void *userdata, unsigned video_width, unsigned video_height,
							  settings_t *settings, math_matrix_4x4 *mymat) {
	gfx_display_ctx_driver_t *dispctx = p_disp->dispctx;
	...
	float footer_text_y =
		(float)video_height - (ozone->dimensions.footer_height / 2.0f) + ozone->fonts.footer.line_centre_offset;
	...
	float icon_y = (float)video_height - (ozone->dimensions.footer_height / 2.0f) - (icon_size / 2.0f);
	unsigned separator_margin = 30 * scale_factor;
	...
	ozone->footer_labels.fullscreen_thumbnails.show = ozone_fullscreen_thumbnails_available(ozone, menu_st);

	ozone->footer_labels.metadata_override.show =
		ozone->footer_labels.fullscreen_thumbnails.show &&
		ozone_metadata_override_available(ozone, settings->uints.menu_left_thumbnails);

	ozone->footer_labels.random_select.show =
		(ozone->flags & OZONE_FLAG_IS_PLAYLIST) || (ozone->flags & OZONE_FLAG_IS_EXPLORE_LIST) ||
		(ozone->flags & OZONE_FLAG_CURSOR_IN_SIDEBAR) || (ozone->flags2 & OZONE_FLAG2_IS_PLAYLISTS_TAB);

	ozone->footer_labels.cycle_thumbnails.show = ozone->footer_labels.fullscreen_thumbnails.show &&
												 ((ozone->flags2 & OZONE_FLAG2_WANT_FULLSCREEN_THUMBNAILS) ||
												  (ozone->flags2 & OZONE_FLAG2_SHOW_FULLSCREEN_THUMBNAILS)) &&
												 !(ozone->flags & OZONE_FLAG_IS_FILE_LIST) &&
												 string_is_empty(ozone->savestate_thumbnail_file_path);
	...
	ozone->footer_labels.clear_setting.show =
		!ozone->footer_labels.cycle_thumbnails.show && ozone_clear_available(ozone, selection);

	ozone->footer_labels.scan.show = !ozone->footer_labels.cycle_thumbnails.show &&
									 !ozone->footer_labels.clear_setting.show && ozone_scan_available(ozone, selection);

	ozone->footer_labels.reset_to_default.show =
		!ozone->footer_labels.fullscreen_thumbnails.show && ozone_is_current_entry_settings(selection);

	ozone->footer_labels.help.show = !ozone->footer_labels.metadata_override.show &&
									 ozone_help_available(ozone, selection, settings->bools.menu_show_sublabels);

	ozone->footer_labels.manage.show = ozone_manage_available(ozone, selection);
	...
	ozone->footer_labels.resume.show = !retroarch_ctl(RARCH_CTL_IS_DUMMY_CORE, NULL);
	...
	ozone->footer_labels.search.x =
		(ozone->footer_labels.search.show)
			? ((input_menu_swap_ok_cancel_buttons) ? ozone->footer_labels.ok.x : ozone->footer_labels.back.x) -
				  ozone->footer_labels.search.width - icon_spacer
			: ((input_menu_swap_ok_cancel_buttons) ? ozone->footer_labels.ok.x : ozone->footer_labels.back.x);
	...
	ozone->footer_labels.scan.x = (ozone->footer_labels.scan.show) ? ozone->footer_labels.clear_setting.x -
																		 ozone->footer_labels.scan.width - icon_spacer
																   : ozone->footer_labels.clear_setting.x;
	...
	ozone->footer_labels.help.x = (ozone->footer_labels.help.show) ? ozone->footer_labels.reset_to_default.x -
																		 ozone->footer_labels.help.width - icon_spacer
																   : ozone->footer_labels.reset_to_default.x;
	...
	ozone->footer_labels.metadata_override.x =
		ozone->footer_labels.manage.x - ozone->footer_labels.metadata_override.width - icon_spacer;

	/* Separator */
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, separator_margin,
						  video_height - ozone->dimensions.footer_height, video_width - separator_margin * 2,
						  ozone->dimensions.spacer_1px, video_width, video_height,
						  ozone->theme->header_footer_separator, NULL);
		...
		if(dispctx->draw) {
			...
			if(ozone->footer_labels.resume.show)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
								...
								ozone->footer_labels.resume.x, icon_y, video_width, video_height, 0.0f, 1.0f, col,
								mymat);
			...
			ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
							...
							ozone->footer_labels.ok.x, icon_y, video_width, video_height, 0.0f, 1.0f, col, mymat);
			...
			ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
							input_menu_swap_ok_cancel_buttons
								? ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_INPUT_BTN_R]
								: ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_INPUT_BTN_D],
							ozone->footer_labels.back.x, icon_y, video_width, video_height, 0.0f, 1.0f, col, mymat);

			/* > Search */
			if(ozone->footer_labels.search.show)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
								ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_INPUT_BTN_U],
								ozone->footer_labels.search.x, icon_y, video_width, video_height, 0.0f, 1.0f, col,
								mymat);
			...
			if(ozone->footer_labels.cycle_thumbnails.show)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
								ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_INPUT_BTN_U],
								ozone->footer_labels.cycle_thumbnails.x, icon_y, video_width, video_height, 0.0f, 1.0f,
								col, mymat);
			...
			if(ozone->footer_labels.random_select.show)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
								...
								ozone->footer_labels.random_select.x, icon_y, video_width, video_height, 0.0f, 1.0f,
								col, mymat);
			...
			if(ozone->footer_labels.fullscreen_thumbnails.show)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
								...
								ozone->footer_labels.fullscreen_thumbnails.x, icon_y, video_width, video_height, 0.0f,
								1.0f, col, mymat);
			...
			if(ozone->footer_labels.metadata_override.show)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
								...
								ozone->footer_labels.metadata_override.x, icon_y, video_width, video_height, 0.0f, 1.0f,
								col, mymat);
			...
			if(ozone->footer_labels.reset_to_default.show)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
								ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_INPUT_START],
								ozone->footer_labels.reset_to_default.x, icon_y, video_width, video_height, 0.0f, 1.0f,
								col, mymat);
			...
			if(ozone->footer_labels.help.show)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
								ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_INPUT_SELECT],
								ozone->footer_labels.help.x, icon_y, video_width, video_height, 0.0f, 1.0f, col, mymat);

			/* > Clear setting */
			if(ozone->footer_labels.clear_setting.show)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
								ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_INPUT_BTN_L],
								ozone->footer_labels.clear_setting.x, icon_y, video_width, video_height, 0.0f, 1.0f,
								col, mymat);
			...
			if(ozone->footer_labels.scan.show)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
								ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_INPUT_BTN_L],
								ozone->footer_labels.scan.x, icon_y, video_width, video_height, 0.0f, 1.0f, col, mymat);

			/* > Manage */
			if(ozone->footer_labels.manage.show)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, icon_size, icon_size,
								ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_INPUT_START],
								ozone->footer_labels.manage.x, icon_y, video_width, video_height, 0.0f, 1.0f, col,
								mymat);
		}
	...
	/* > Resume */
	if(ozone->footer_labels.resume.show)
		gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.resume.str,
							  ozone->footer_labels.resume.x + icon_size + icon_padding_small, footer_text_y,
							  video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f,
							  false);

	/* > Ok */
	gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.ok.str,
						  ozone->footer_labels.ok.x + icon_size + icon_padding_small, footer_text_y, video_width,
						  video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f, false);

	/* > Back */
	gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.back.str,
						  ozone->footer_labels.back.x + icon_size + icon_padding_small, footer_text_y, video_width,
						  video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f, false);

	/* > Search */
	if(ozone->footer_labels.search.show)
		gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.search.str,
							  ozone->footer_labels.search.x + icon_size + icon_padding_small, footer_text_y,
							  video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f,
							  false);

	/* > Thumbnail cycle */
	if(ozone->footer_labels.cycle_thumbnails.show)
		gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.cycle_thumbnails.str,
							  ozone->footer_labels.cycle_thumbnails.x + icon_size + icon_padding_small, footer_text_y,
							  video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f,
							  false);

	/* > Random select */
	if(ozone->footer_labels.random_select.show)
		gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.random_select.str,
							  ozone->footer_labels.random_select.x + icon_size + icon_padding_small, footer_text_y,
							  video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f,
							  false);

	/* > Fullscreen thumbnails */
	if(ozone->footer_labels.fullscreen_thumbnails.show)
		gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.fullscreen_thumbnails.str,
							  ozone->footer_labels.fullscreen_thumbnails.x + icon_size + icon_padding_small,
							  footer_text_y, video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f,
							  false, 1.0f, false);

	/* > Metadata toggle */
	if(ozone->footer_labels.metadata_override.show)
		gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.metadata_override.str,
							  ozone->footer_labels.metadata_override.x + icon_size + icon_padding_small, footer_text_y,
							  video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f,
							  false);

	/* > Reset to default */
	if(ozone->footer_labels.reset_to_default.show)
		gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.reset_to_default.str,
							  ozone->footer_labels.reset_to_default.x + icon_size + icon_padding_small, footer_text_y,
							  video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f,
							  false);

	/* > Help */
	if(ozone->footer_labels.help.show)
		gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.help.str,
							  ozone->footer_labels.help.x + icon_size + icon_padding_small, footer_text_y, video_width,
							  video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f, false);

	/* > Clear settings */
	if(ozone->footer_labels.clear_setting.show)
		gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.clear_setting.str,
							  ozone->footer_labels.clear_setting.x + icon_size + icon_padding_small, footer_text_y,
							  video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f,
							  false);

	/* > Scan entry */
	if(ozone->footer_labels.scan.show)
		gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.scan.str,
							  ozone->footer_labels.scan.x + icon_size + icon_padding_small, footer_text_y, video_width,
							  video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f, false);

	/* > Manage */
	if(ozone->footer_labels.manage.show)
		gfx_display_draw_text(ozone->fonts.footer.font, ozone->footer_labels.manage.str,
							  ozone->footer_labels.manage.x + icon_size + icon_padding_small, footer_text_y,
							  video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT, 1.0f, false, 1.0f,
							  false);
	...
	if(menu_core_enable) {
		 ...
		 * title string */
		usable_width = ozone->footer_labels.metadata_override.show		 ? ozone->footer_labels.metadata_override.x
					   : ozone->footer_labels.fullscreen_thumbnails.show ? ozone->footer_labels.fullscreen_thumbnails.x
																		 : ozone->footer_labels.search.x;
		...
		if(usable_width > 0) {
			...
			/* Draw text */
			gfx_display_draw_text(ozone->fonts.footer.font, core_title_buf, ticker_x_offset + footer_margin,
								  footer_text_y, video_width, video_height, ozone->theme->text_rgba, TEXT_ALIGN_LEFT,
								  1.0f, false, 1.0f, false);
		}
	}
#ifdef HAVE_LIBNX
		...
		if(dispctx) {
			if(dispctx->blend_begin)
				dispctx->blend_begin(userdata);
			if(dispctx->draw)
				ozone_draw_icon(p_disp, userdata, video_width, video_height, 69 * scale_factor, 30 * scale_factor,
								ozone->theme->textures[OZONE_THEME_TEXTURE_SWITCH], footer_margin,
								video_height - ozone->dimensions.footer_height / 2 - 15 * scale_factor, video_width,
								video_height, 0.0f, 1.0f, ozone->pure_white, mymat);
			if(dispctx->blend_end)
				dispctx->blend_end(userdata);
		}
	}
...
static void ozone_frame(void *data, video_frame_info_t *video_info) {
	...
	if(draw_osk != draw_osk_old) {
		...
		if(!draw_osk) {
			ozone->flags &= ~(OZONE_FLAG_SHOULD_DRAW_MSGBOX | OZONE_FLAG_MSGBOX_STATE | OZONE_FLAG_MSGBOX_STATE_OLD);
			ozone->animations.messagebox_alpha = 0.0f;
		}
	}

	/* Change theme on the fly */
	ozone_last_use_preferred_system_color_theme = ozone->flags2 & OZONE_FLAG2_LAST_USE_PREFERRED_SYSTEM_COLOR_THEME;
	 ...
	 * screensaver and return */
	if(ozone->flags & OZONE_FLAG_SHOW_SCREENSAVER) {
		menu_screensaver_frame(ozone->screensaver, video_info, p_disp);
		return;
	}

	if(video_st->current_video && video_st->current_video->set_viewport)
		video_st->current_video->set_viewport(video_st->data, video_width, video_height, true, false);
	...
	gfx_display_draw_quad(p_disp, userdata, video_width, video_height, 0, 0, video_width, video_height, video_width,
						  video_height, background_color, NULL);
	...
	/* Header, footer */
	ozone_draw_header(ozone, p_disp, p_anim, settings, userdata, video_width, video_height, battery_level_enable,
					  timedate_enable, &mymat);

	ozone_draw_footer(ozone, menu_st, p_disp, p_anim, userdata, video_width, video_height, settings, &mymat);

	/* Sidebar */
	if(ozone->flags & OZONE_FLAG_DRAW_SIDEBAR)
		ozone_draw_sidebar(ozone, p_disp, p_anim, settings->bools.menu_ticker_smooth,
						   (enum gfx_animation_ticker_type)settings->uints.menu_ticker_type, userdata, video_width,
						   video_height, libretro_running, menu_framebuffer_opacity, &mymat);
	...
	/* Current list */
	ozone_draw_entries(ozone, p_disp, p_anim, settings, userdata, video_width, video_height, (unsigned)ozone->selection,
					   (unsigned)ozone->selection_old, MENU_LIST_GET_SELECTION(menu_list, 0),
					   ozone->animations.list_alpha, ozone->animations.scroll_y,
					   (ozone->flags & OZONE_FLAG_IS_PLAYLIST) ? true : false, &mymat);

	/* Old list */
	if(ozone->flags & OZONE_FLAG_DRAW_OLD_LIST)
		ozone_draw_entries(ozone, p_disp, p_anim, settings, userdata, video_width, video_height,
						   (unsigned)ozone->selection_old_list, (unsigned)ozone->selection_old_list,
						   &ozone->selection_buf_old, ozone->animations.list_alpha, ozone->scroll_old,
						   (ozone->flags & OZONE_FLAG_IS_PLAYLIST_OLD) ? true : false, &mymat);

	/* Thumbnail bar */
	if(ozone->show_thumbnail_bar && !(ozone->flags2 & OZONE_FLAG2_SHOW_FULLSCREEN_THUMBNAILS))
		ozone_draw_thumbnail_bar(ozone, menu_st, p_disp, p_anim, settings, userdata, video_width, video_height,
								 libretro_running, menu_framebuffer_opacity, &mymat);
	...
	ozone_draw_fullscreen_thumbnails(ozone, userdata, video_info->disp_userdata, video_width, video_height);

	/* Message box & OSK - second layer of text */
	if((ozone->flags & OZONE_FLAG_SHOULD_DRAW_MSGBOX) || draw_osk) {
		/* Fade in animation */
		...
		ozone_draw_backdrop(userdata, video_info->disp_userdata, video_width, video_height,
							float_min(ozone->animations.messagebox_alpha, (draw_osk) ? 0.95f : 0.75f));
		...
		if(draw_osk) {
			...
			ozone_draw_osk(ozone, userdata, video_info->disp_userdata, video_width, video_height, label, str);
		} else
			ozone_draw_messagebox(ozone, p_disp, userdata, video_width, video_height, ozone->pending_message, &mymat);
	...
	/* Cursor */
	if((ozone->flags & OZONE_FLAG_SHOW_CURSOR) && (ozone->pointer.type != MENU_POINTER_DISABLED)) {
		bool cursor_visible = (video_fullscreen || mouse_grabbed) && menu_mouse_enable;

		gfx_display_set_alpha(ozone->pure_white, 1.0f);
		if(cursor_visible)
			gfx_display_draw_cursor(p_disp, userdata, video_width, video_height, cursor_visible, ozone->pure_white,
									ozone->dimensions.cursor_size,
									ozone->icons_textures[OZONE_ENTRIES_ICONS_TEXTURE_POINTER], ozone->pointer.x,
									ozone->pointer.y, video_width, video_height);
	}
	...
	if(video_st->current_video && video_st->current_video->set_viewport)
		video_st->current_video->set_viewport(video_st->data, video_width, video_height, false, true);
}

static void ozone_set_header(ozone_handle_t *ozone) {
	if((ozone->categories_selection_ptr <= ozone->system_tab_end) ||
	   ((ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU) && !menu_is_running_quick_menu()) || (ozone->depth > 1))
...
static void ozone_populate_entries(void *data, const char *path, const char *label, unsigned k) {
	...
	if((menu_st->flags & MENU_ST_FLAG_PREVENT_POPULATE) > 0) {
		...
		if(ozone->flags & OZONE_FLAG_IS_PLAYLIST) {
			...
			size_t num_search_terms = menu_search_terms ? menu_search_terms->size : 0;
	...
	if(was_db_manager_list)
		ozone->flags |= OZONE_FLAG_IS_DB_MANAGER_LIST | OZONE_FLAG_SKIP_THUMBNAIL_RESET;
	...
	if((!(ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU)) && (ozone->flags & OZONE_FLAG_WAS_QUICK_MENU) &&
	   (!(ozone->flags & OZONE_FLAG_IS_STATE_SLOT)) &&
	   (gfx_thumbnail_is_enabled(menu_st->thumbnail_path_data, GFX_THUMBNAIL_RIGHT) ||
		gfx_thumbnail_is_enabled(menu_st->thumbnail_path_data, GFX_THUMBNAIL_LEFT)) &&
	   (ozone->thumbnails.left.status == GFX_THUMBNAIL_STATUS_AVAILABLE ||
	...
	if(ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU) {
		if(menu_is_running_quick_menu()) {
			ozone->flags &= ~(OZONE_FLAG_WANT_THUMBNAIL_BAR | OZONE_FLAG_SKIP_THUMBNAIL_RESET);
			ozone_update_savestate_thumbnail_path(ozone, menu_st->selection_ptr);
			ozone_update_savestate_thumbnail_image(ozone);
		...
		ozone_set_thumbnail_content(ozone, "");
		ozone_update_thumbnail_image(ozone);
	} else if((!(ozone->flags & OZONE_FLAG_IS_STATE_SLOT)) && (!(ozone->flags & OZONE_FLAG_SKIP_THUMBNAIL_RESET))) {
	...
	if(((ozone->flags & OZONE_FLAG_WANT_THUMBNAIL_BAR)) &&
	   (((ozone->flags & OZONE_FLAG_IS_PLAYLIST) && (ozone->depth == 1 || ozone->depth == 3)) ||
		((ozone->flags & OZONE_FLAG_IS_DB_MANAGER_LIST) && (ozone->depth >= 4)) ||
		(ozone->flags & OZONE_FLAG_IS_EXPLORE_LIST) || (ozone->flags & OZONE_FLAG_IS_FILE_LIST) ||
		(ozone->flags & OZONE_FLAG_IS_STATE_SLOT) || (ozone->flags2 & OZONE_FLAG2_IS_QUICK_MENU)))
		ozone->flags |= OZONE_FLAG_FULLSCREEN_THUMBNAILS_AVAILABLE;
	else
		ozone->flags &= ~OZONE_FLAG_FULLSCREEN_THUMBNAILS_AVAILABLE;
...
static bool ozone_menu_init_list(void *data) {
	...
	menu_entries_append(menu_stack, info.path, info.label, MENU_ENUM_LABEL_MAIN_MENU, info.type, info.flags, 0, NULL);
...
static void ozone_list_insert(void *userdata, file_list_t *list, const char *path, const char *fullpath,
...
static void ozone_messagebox(void *data, const char *message) {
	...
	ozone->flags |= OZONE_FLAG_SHOULD_DRAW_MSGBOX | OZONE_FLAG_MSGBOX_STATE;
}
...
static int ozone_list_bind_init(menu_file_list_cbs_t *cbs, const char *path, const char *label, unsigned type,
								size_t idx) {
...
static int ozone_tap_footer(ozone_handle_t *ozone, unsigned x, unsigned video_width, menu_entry_t *entry) {
	struct menu_state *menu_st = menu_state_get_ptr();
	size_t selection = menu_st->selection_ptr;
	settings_t *settings = config_get_ptr();
	bool input_menu_swap_ok_cancel_buttons = settings->bools.input_menu_swap_ok_cancel_buttons;
...
static int ozone_pointer_up(void *userdata, unsigned x, unsigned y, unsigned ptr,
							enum menu_input_pointer_gesture gesture, menu_file_list_cbs_t *cbs, menu_entry_t *entry,
							unsigned action) {
	...
	switch(gesture) {
		...
		case MENU_INPUT_GESTURE_SHORT_PRESS:
			...
			/* Tap/press entries: Activate and/or select item */
			else if((ptr < entries_end) && ((int)x > (int)(ozone->dimensions_sidebar_width + ozone->sidebar_offset)) &&
				...
				if(gesture == MENU_INPUT_GESTURE_TAP) {
					...
					else if((ozone->flags & OZONE_FLAG_IS_PLAYLIST) && (ozone->depth == 1) && (ptr != selection)) {
						ozone_set_thumbnail_content(ozone, "");
						ozone_update_thumbnail_image(ozone);
					}
				}
		...
		case MENU_INPUT_GESTURE_LONG_PRESS:
			...
			if(((int)y > ozone->dimensions.header_height) &&
			   ((int)y < (int)(height - ozone->dimensions.footer_height)) && (ptr < entries_end) &&
			   (ptr == selection) && ((int)x > ozone->dimensions_sidebar_width + ozone->sidebar_offset) &&
		...
		case MENU_INPUT_GESTURE_SWIPE_LEFT:
			...
			if((ozone->pointer.type != MENU_POINTER_MOUSE) && (ozone->flags & OZONE_FLAG_IS_PLAYLIST) &&
			   (ozone->depth == 1))
...
menu_ctx_driver_t menu_ctx_ozone = {NULL, /* set_texture */
									ozone_messagebox,
									ozone_render,
									ozone_frame,
									ozone_init,
